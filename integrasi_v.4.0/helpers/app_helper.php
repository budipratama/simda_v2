...
if ( ! function_exists('get_button'))
{
	function get_button($id)
	{
		$ci= & get_instance();
		$ci->load->helper('url');
		$html  = '<center><a href="'. site_url($ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/transfer/'.$id) .'" class="btn bg-purple btn-circle waves-effect waves-circle waves-float" title="Transfer"><i class="material-icons">near_me</i></a>&nbsp;';
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/detail/'.$id) .'" class="btn btn-info btn-circle waves-effect waves-circle waves-float" title="Detail"><i class="material-icons">assignment</i></a>&nbsp;';
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/delete/'.$id) .'" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" data-placement="left" title="Hapus" onclick="return confirm(\'Apakah anda yakin? \nAkan menghapus data rencana kerja ini.\');"><i class="material-icons">delete_forever</i></a>';
...
if ( ! function_exists('get_buttons'))
{
	function get_buttons($id)
	{
		$ci= & get_instance();
		$ci->load->helper('url');
		$html  = '<center><a href="'. site_url($ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/detail/'.$id) .'" class="btn btn-info btn-circle waves-effect waves-circle waves-float" title="Detail"><i class="material-icons">assignment</i></a>&nbsp;';
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/edit/'.$id) .'" class="btn btn-warning btn-circle waves-effect waves-circle waves-float" title="Ubah"><i class="material-icons">border_color</i></a>&nbsp;';
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/delete/'.$id) .'" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" title="Hapus" data-placement="left" onclick="return confirm(\'Apakah anda yakin? \nAkan menghapus data rencana kerja ini.\');"><i class="material-icons">delete_forever</i></a>';
