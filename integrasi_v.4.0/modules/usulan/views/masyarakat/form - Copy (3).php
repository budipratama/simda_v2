                                ...
                                <div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-2 box-image" style="position:relative;height:115px;overflow:hidden;margin-bottom:30px;">
											...
											<div id="photo-preview<?php echo $i; ?>" class="photo-preview" style="display: none;position:relative;top:-114px;height:115px;"><img src="" id="img-preview<?php echo $i; ?>" style="width:100%;height:auto;" /></div>
											<div id="action-preview<?php echo $i; ?>" class="action-preview" style="display: none;position:relative;top:-132px;height:18px;background:#CCC;opacity:0.5">
												<span>
