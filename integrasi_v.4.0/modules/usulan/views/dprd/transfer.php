<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Transfer Pokok-Pokok Pikiran DPRD
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('usulan/dprd');?>">Pokok-Pokok Pikiran DPRD</a>
						<i class="fa fa-angle-right"></i>
					</li>
                     <li>
						<a href="#">Transfer</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-paper-plane"></i>Transfer Pokok-Pokok Pikiran DPRD
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('usulan/dprd/doTransfer/btl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
                                                ...
                                                <div class="row">
                                               		<div class="col-md-12">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="penerima" value="<?php echo $penerima; ?>" id="penerima" placeholder="" required="required">
														</div>
													</div>
													<!--/span-->
                                                </div>
												...
												<div class="row">
													<?php for($i=0;$i<6;$i++){?>
                                                	<div class="col-md-2 box-image" style="position:relative;height:115px;overflow:hidden;margin-bottom:30px;">
														...
														<div id="photo-preview<?php echo $i; ?>" class="photo-preview" style="display: none;position:relative;top:1px;height:115px;"><img src="" id="img-preview<?php echo $i; ?>" style="width:100%;height:auto;" /></div>
														<div id="action-preview<?php echo $i; ?>" class="action-preview" style="display: none;position:relative;top:-18px;height:18px;background:#CCC;opacity:0.5">
															<span>
													...
													<div class="col-md-5">
														<div class="form-group">
															...
															<div class="input-group">
																<input type="text" class="form-control" name="koordinat" id="koordinat" placeholder="-6.238634, 107.140463" readonly="readonly">
																<span class="input-group-btn">
																<a class="btn red" href="#mapmodals" data-toggle="modal"><span class="fa fa-map-marker"></span> Ambil Lokasi</a>
																</span>
															</div>
														</div>
													</div>
