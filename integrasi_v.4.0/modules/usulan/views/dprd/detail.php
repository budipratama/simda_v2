<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Detail Pokok-Pokok Pikiran DPRD
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('usulan/dprd/hasil');?>">Hasil Pokok-Pokok Pikiran DPRD</a>
					</li>
					<li>
						<a href="#">Detail Pokok-Pokok Pikiran DPRD</a>
					</li>
				</ul>
			</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Data Detail Pokok-Pokok Pikiran DPRD
							</div>
						</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													...
													<?php if (in_array($admin_log['level_kode'], array('1', '5'))){?>
													<a href="<?php echo site_url('usulan/dprd/transfer/'.$kode);?>" class="btn blue"><i class="fa fa-paper-plane"></i> Transfer ke Rencana Kerja</a>
													<?php } ?>
												</div>
											</div>
										</div>
