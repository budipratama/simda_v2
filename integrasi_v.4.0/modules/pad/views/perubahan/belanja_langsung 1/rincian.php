		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<p class="control-label col-md-9"><i class="fa fa-bars"></i> Data Kode Rekening</p><p align="right">
					<a href="<?php echo base_url(); ?>rka/perubahan/belanja/<?php echo $rka->anggaran_kode;?>" class="btn btn-default"><i class="fa fa-reply"></i> Kembali</a>
					<a class="btn btn-success" title="Tambah" href="<?php echo site_url('rka/perubahan/addr/'.$rka->task_id);?>"><i class="fa fa-plus"> Rincian</i></a></p>
				</div>
				<div class="panel-body">
				<!-- BEGIN FORM -->
				<div class="step">
					<ul class="nav nav-tabs nav-justified" role="tablist">
						<li role="step" ><a href="<?php echo base_url(); ?>rka/perubahan/belanja/<?php echo $rka->anggaran_kode;?>"><div class="step-title"><div class="title">Belanja</div></div></a></li>
						<li role="step" class="active">
							<a href="#step1" id="step1-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">								
								<div class="step-title"><div class="title">Rincian Belanja</div></div>
							</a>
						</li>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td><a href="<?php echo base_url(); ?>rka/perubahan/sub/<?php echo $task->kode; ?>"><?php echo $task->uraian; ?></a></td>
									<td style="text-align:center;">										
										<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo base_url(); ?>rka/perubahan/editr/<?php echo $task->kode; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-pencil"></i></a>
										<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" value="<?php echo $task->kode; ?>" href="<?php echo base_url(); ?>rka/perubahan/deleter/<?php echo $task->task_id; ?>/<?php echo $this->uri->segment(1); ?>" ><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
