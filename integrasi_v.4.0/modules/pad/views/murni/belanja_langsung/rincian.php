                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
							...
							<p class="control-label col-md-10">Rekening :&nbsp; <?php echo $pad->id_akun;?>.<?php echo $pad->id_kelompok;?>.<?php echo $pad->id_jenis;?>.<?php echo $pad->id_obyek;?>.<?php echo $pad->id_rincian;?> <?php echo $pad->nama_rincian;?></p>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a title="Tambah" href="<?php echo site_url('pad/murni/addr/'.$pad->task_id);?>"><i class="material-icons">add_circle_outline</i> Rincian Belanja</a></li>
                                        <li><a title="Kembali" href="javascript:void(0);"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="row clearfix">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        <li><p class="col-cyan"><a href="javascript:void(0);"><i class="material-icons">keyboard_arrow_left</i>PAD</a></p></li>									
                                        ...
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tbody><?php if($rincian):?><?php foreach($rincian as $task):?>
												<tr>
													...
													<td><?php echo $task->uraian;?></a></td>
													<td style="text-align:center;">										
														<a class="btn btn-sm btn-warning" title="Ubah" href="javascript:void(0);"><i class="fa fa-pencil"></i></a>														
														<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" href="javascript:void(0);/<?php echo $this->uri->segment(1);?>"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
