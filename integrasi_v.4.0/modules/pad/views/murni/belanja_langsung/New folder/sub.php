                            ...
                            <div class="row clearfix">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        <li><p class="col-cyan"><a href="<?php echo base_url(); ?>rka/murni/belanja/<?php echo $rincian->anggaran_kode;?>"><i class="material-icons">keyboard_arrow_left</i>Belanja</a></p></li>									
                                        <li><p class="col-cyan"><a href="<?php echo base_url(); ?>rka/murni/rincian/<?php echo $rincian->task_id; ?>"><i class="material-icons">keyboard_arrow_left</i>Rincian Belanja</a></p></li>
                                        ...
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tr>
												...
												<td style="text-align:center;">										
													<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo base_url(); ?>rka/murni/edits/<?php echo $task->kode; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-pencil"></i></a>
													<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" value="<?php echo $task->kode; ?>" href="<?php echo base_url(); ?>rka/murni/deletes/<?php echo $task->kode; ?>/<?php echo $this->uri->segment(1); ?>" ><i class="fa fa-trash-o"></i></a>
												</td>
											</tr>
