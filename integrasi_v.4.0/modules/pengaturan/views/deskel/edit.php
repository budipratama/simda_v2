				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Ubah Desa/Kelurahan
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('pengaturan/deskel/update/'.$skpd_kode);?>" class="horizontal-form" method="post">							
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="radio-list">
													...
													<input type="radio" name="skpd_status" id="skpd_status_desa" value="Desa" <?php echo $skpd_status_desa = ($skpd_status == 'Desa')?'checked':''; ?> required="required"> Desa</label>
													<label class="radio-inline" for="skpd_status_kelurahan">
													<input type="radio" name="skpd_status" id="skpd_status_kelurahan" value="Kelurahan" <?php echo $skpd_status_kelurahan = ($skpd_status == 'Kelurahan')?'checked':''; ?> required="required"> Kelurahan</label>
												</div>
											</div>
										</div>
									</div>
