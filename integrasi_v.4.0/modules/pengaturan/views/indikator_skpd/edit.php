				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Ubah Indikator per SKPD
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('pengaturan/indikator-skpd/update/'.$kode);?>" class="horizontal-form" method="post">							
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<?php combobox('db', $visi, 'visi_kode', 'kode', 'visi', $visi_kode, '', 'Pilih Visi', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<?php combobox('db', $misi, 'misi_kode', 'kode', 'misi', $misi_kode, 'show_form_tujuan_by_misi();', 'Pilih Misi', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
											</div>
										</div>
									</div>
									<?php if ($tujuan_kode){?>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group" id="tampil_combobox_sasaran_by_tujuan">
												...
												<?php combobox('db', $sasaran, 'sasaran_kode', 'kode', 'sasaran', $sasaran_kode, 'show_form_indikator_by_sasaran();', 'Pilih Sasaran', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
											</div>
										</div>
									</div>
									<?php } else { ?>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group" id="tampil_combobox_indikator_by_sasaran">
												...
												<?php combobox('db', $indikator, 'indikator_kode', 'kode', 'indikator', $indikator_kode, '', 'Pilih Indikator', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
											</div>
										</div>
									</div>
									<?php } else { ?>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group" id="tampil_combobox_program_by_urusan">
												...
												<?php combobox('db', $program, 'program_kode', 'kode', 'program', $program_kode, '', 'Pilih Program', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
											</div>
										</div>
									</div>
									<?php } else { ?>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<?php combobox('db', $skpd, 'skpd_kode', 'skpd_kode', 'skpd_nama', $skpd_kode, '', 'Pilih SKPD', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
											</div>
										</div>
									</div>
								</div>
