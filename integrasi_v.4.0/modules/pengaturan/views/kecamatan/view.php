<!-- Main Content -->
   <section class="content">
		<h2>Daftar Kecamatan <small>entri data &amp; informasi detail</small></h2>  
			<div class="body">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<h2>Control Panel<small>Data Kecamatan</small></h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
										<li><a href="#" data-toggle="modal" data-target="#addKecamatan"><i class="material-icons">add_circle</i> Kecamatan</a></li>
...
<!-- END Main Content -->
	<a href="#addKecamatan" data-toggle="modal"></a>
	<div id="addKecamatan" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><center>Tambah Kecamatan/Kelurahan</center></h4><hr>
				</div>
				<form action="<?php echo site_url('pengaturan/kecamatan/insert');?>" class="form-horizontal" method="post">
						...
						<div class="body">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="col-md-6">
										<p><b>Kecamatan/Kelurahan <span class="required">*</span></b></p>
                            ...
                            <div class="row clearfix">
								...
								<div class="col-md-4">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <label class="form-label">Nomor Kecamatan</label>
                                    </div>
									</div>
                                </div>
								<div class="col-md-5">
...
<script>
	function show_form_skpd_by_urusan(){
		...
		load('pengaturan/kecamatan/tampil_combobox_skpd_by_urusan/'+aaa_kode, '#tampil_combobox_skpd_by_urusan');
	}
	</script>