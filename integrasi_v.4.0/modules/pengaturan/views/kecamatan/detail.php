<!-- Main Content -->
   <section class="content">
		<h2>Detail Kecamatan <small>entri data &amp; informasi detail</small></h2>  
			<div class="body">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?php echo site_url('pengaturan/kecamatan');?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
												...
												<div class="col-md-6">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															<a href="<?php echo site_url('pengaturan/kecamatan/edit/'.$skpd_kode);?>" class="btn btn-primary waves-effect">Ubah Data</a>
															<a href="<?php echo site_url('pengaturan/kecamatan');?>" class="btn btn-default waves-effect">Kembali</a>
														</div>
													</div>
												</div>
												<div class="col-md-6">
