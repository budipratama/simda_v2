				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Tambah Kecamatan
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('pengaturan/kecamatan/insert');?>" class="horizontal-form" method="post">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-2">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="skpd_kd" id="skpd_kd" placeholder="3216XX" required="required">
											</div>
										</div>
										<div class="col-md-2">
											<div class="form-group">
										...
										<div class="col-md-8">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="skpd_nama" id="skpd_nama" placeholder="Kecamatan " required="required">
											</div>
										</div>
									</div>
									<div class="row">
