												...
												<div class="col-md-6">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															<a href="<?php echo site_url('pengaturan/skpd/edit/'.$skpd_kode);?>" class="btn btn-primary waves-effect">Ubah Data</a>
															<a href="<?php echo site_url('pengaturan/skpd');?>" class="btn btn-default waves-effect">Kembali</a>
														</div>
													</div>
												</div>
												<div class="col-md-6">
