				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Ubah Waktu Entri
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('pengaturan/waktu-entri/update/'.$kode);?>" class="horizontal-form" method="post">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="nama" id="nama" value="<?php echo $nama; ?>" placeholder="" required="required">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												...
												<div class="input-group date form_datetime">
													<input type="text" name="mulai" id="mulai" size="16" value="<?php echo $mulai; ?>" readonly class="form-control" required="required">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<div class="input-group date form_datetime">
													<input type="text" name="selesai" id="selesai" size="16" value="<?php echo $selesai; ?>" readonly class="form-control" required="required">
													<span class="input-group-btn">
													<button class="btn default date-set" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
