				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Ubah Visi
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('pengaturan/visi/update/'.$kode);?>" class="horizontal-form" method="post">							
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="visi" id="visi" required="required"><?php echo $visi; ?></textarea>
											</div>
										</div>
									</div>
								</div>
