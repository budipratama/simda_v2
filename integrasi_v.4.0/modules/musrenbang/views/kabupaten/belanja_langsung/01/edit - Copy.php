<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Ubah Musrenbang Kabupaten <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
                     ...
                     <li>
						<a href="#">Ubah Belanja Langsung</a>
					</li>
				</ul>
			</div>
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form ubah musrenbang kabupaten ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-pencil"></i>Ubah Musrenbang Kabupaten
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kabupaten/update/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<?php combobox('db', $tahun, 'tahun', 'tahun', 'tahun', $tahun_, '', 'Pilih Tahun Anggaran', 'class="select2_category form-control" tabindex="1" required="required" readonly="readonly"'); ?>
														</div>
													</div>
													<!--/span-->
                                                	<div class="col-md-9">
														<div class="form-group">
															...
															<?php if ($skpd_aktive == 'yes') { combobox('db', $skpd, 'skpd_kode', 'skpd_kode', 'skpd_nama', $skpd_, 'show_form_misi_by_skpd();', 'Pilih SKPD Pelaksana', 'class="select2_category form-control" tabindex="1" required="required" readonly="readonly"');
															} else { 
												...
												<div class="row">
                                                	<div class="col-md-12">
														<div class="form-group" id="tampil_combobox_misi_by_skpd">
															...
															<?php combobox('db', $misi, 'misi_kode', 'misi_kode', 'misi_nama', $misi_, 'show_form_tujuan_by_misi();', 'Pilih Misi', 'class="select2_category form-control" tabindex="1" required="required" readonly="readonly"'); ?>
														</div>
													</div>
													<!--/span-->
                                                </div>
                                                ...
                                                <div class="row">
                                                	<div class="col-md-6">
														<div class="form-group">
															...
															<?php combobox('db', $prioritas, 'prioritas_kode', 'kode', 'prioritas', $prioritas_, '', 'Pilih Prioritas', 'class="select2_category form-control" tabindex="1" required="required" readonly="readonly"'); ?>
														</div>
													</div>
													<!--/span-->
                                                	<div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="row">
															<div class="col-md-offset-3 col-md-9">
																<button type="submit" class="btn green"><i class="fa fa-check"></i> Simpan & Ubah Data</button>
	...
	function show_form_misi_by_skpd(){
		...
		load('musrenbang/kabupaten/tampil_combobox_misi_by_skpd/'+skpd_kode, '#tampil_combobox_misi_by_skpd');
		load('musrenbang/kabupaten/tampil_combobox_tujuan_by_misi/', '#tampil_combobox_tujuan_by_misi');
		load('musrenbang/kabupaten/tampil_combobox_sasaran_by_tujuan/', '#tampil_combobox_sasaran_by_tujuan');
		load('musrenbang/kabupaten/tampil_combobox_indikator_by_sasaran/', '#tampil_combobox_indikator_by_sasaran');
		load('musrenbang/kabupaten/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('musrenbang/kabupaten/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	
	function show_form_tujuan_by_misi(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var misi_kode = $('select[name=misi_kode]').val();
		load('musrenbang/kabupaten/tampil_combobox_tujuan_by_misi/'+skpd_kode+'/'+misi_kode, '#tampil_combobox_tujuan_by_misi');
		load('musrenbang/kabupaten/tampil_combobox_sasaran_by_tujuan/', '#tampil_combobox_sasaran_by_tujuan');
		load('musrenbang/kabupaten/tampil_combobox_indikator_by_sasaran/', '#tampil_combobox_indikator_by_sasaran');
		load('musrenbang/kabupaten/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('musrenbang/kabupaten/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	...
	function show_form_sasaran_by_tujuan(){
		...
		load('musrenbang/kabupaten/tampil_combobox_sasaran_by_tujuan/'+skpd_kode+'/'+tujuan_kode, '#tampil_combobox_sasaran_by_tujuan');
		load('musrenbang/kabupaten/tampil_combobox_indikator_by_sasaran/', '#tampil_combobox_indikator_by_sasaran');
		load('musrenbang/kabupaten/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('musrenbang/kabupaten/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_indikator_by_sasaran(){
		...
		load('musrenbang/kabupaten/tampil_combobox_indikator_by_sasaran/'+skpd_kode+'/'+tujuan_kode+'/'+sasaran_kode, '#tampil_combobox_indikator_by_sasaran');
		load('musrenbang/kabupaten/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('musrenbang/kabupaten/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_urusan_by_indikator(){
		...
		load('musrenbang/kabupaten/tampil_combobox_urusan_by_indikator/'+skpd_kode+'/'+tujuan_kode+'/'+indikator_kode, '#tampil_combobox_urusan_by_indikator');
		load('musrenbang/kabupaten/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_program_by_urusan(){
		...
		load('musrenbang/kabupaten/tampil_combobox_program_by_urusan/'+skpd_kode+'/'+urusan_kode, '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_kegiatan_by_program(){
		...
		var skpd_kode = $('select[name=skpd_kode]').val();
		load('musrenbang/kabupaten/tampil_combobox_kegiatan_by_program/'+urusan_kode+'/'+program_kode+'/'+skpd_kode, '#tampil_combobox_kegiatan_by_program');
		load('musrenbang/kabupaten/tampil_combobox_hasil_by_program/'+program_kode, '#tampil_combobox_hasil_by_program');
		load('musrenbang/kabupaten/tampil_kegiatan_lainnya/', '#tampil_combobox_kegiatan_lainnya');
	}

	function show_form_kegiatan_lainnya(){
		var kegiatan = $('select[name=kegiatan]').val();
		load('musrenbang/kabupaten/tampil_kegiatan_lainnya/'+kegiatan, '#tampil_combobox_kegiatan_lainnya');
	}
	
	function show_form_deskel_by_kecamatan(){
		var kecamatan_kode = $('select[name=kecamatan_kode]').val();
		load('musrenbang/kabupaten/tampil_combobox_deskel_by_kecamatan2/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
