...
<div class="container-fluid">
	<div class="side-body padding-top">
		<h3 class="page-title">Ubah Musrenbang Kabupaten <small>anggaran belanja langsung</small></h3>
		<div class="row">
			<div class="col-xs-12">
...
<!-- END PAGE HEADER-->
			...
			<!-- BEGIN FORM -->
                <div class="panel panel-success">
						<div class="panel-heading"><i class="fa fa-pencil-square-o"></i> Ubah Pra Rencana Kerja</div>
