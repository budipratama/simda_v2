<!-- BEGIN CONTENT -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-refresh"></i>Sinkronisasi Musrenbang Desa
							</div>
							<div class="tools">
						...
						<div class="portlet-body form" style="<?php echo (isset($formCari)?'display:none;':'')?>">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('musrenbang/desa/sync-process');?>" class="form-horizontal" method="post">
								<div class="form-body">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3" for="jenis">Sinkronisasi <span class="required">*</span></label>
												<div class="col-md-9">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-3" for="tipe">Jenis Belanja <span class="required">*</span></label>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group" id="tampil_combobox_deskel_by_kecamatan">
												<label class="control-label col-md-3" for="deskel_kode">Desa <span class="required">*</span></label>
												<div class="col-md-9">
												<?php if ($deskel_ == 'deskel' || $deskel_ == ''){ 
													if ($admin_log['level_kode'] == 14){
														...
														combobox('db', $deskel, 'deskel_kode', 'skpd_kd', 'skpd_nama', $deskel_, '', 'Pilih Desa', 'class="select2_category form-control" tabindex="1" required="required"'); 
													} else { ?>
													...
													if ($deskel_aktive == 'yes') { combobox('db', $deskel, 'deskel_kode', 'skpd_kd', 'skpd_nama', $deskel_, '', 'Pilih Desa', 'class="select2_category form-control" tabindex="1" required="required"'); 
													} else {
													echo '<select class="select2_category form-control" name="deskel_kode" id="deskel_kode" data-placeholder="Pilih Desa" tabindex="1" required="required">
													<option value="'.$deskel_kode.'" selected>'.$deskel_nama.'</option>
													</select>';
										...
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-offset-1 col-md-12">
													...
													<a href="<?php echo site_url('musrenbang/desa');?>" class="btn default"> <i class="fa fa-reply"></i> Kembali</a>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											...
											<div class="col-md-12">
												...
												<?php if ($jumlah_sama > 0){ ?>
													<div class="col-md-offset-1 col-md-12">
														...
														<a href="<?php echo site_url('musrenbang/desa/sync');?>" class="btn default"> <i class="fa fa-reply"></i> Kembali</a>
													</div>
												<?php } else { ?>
													<div class="col-md-offset-1 col-md-12">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						...
						<div class="portlet-body form">
							<form action="<?php echo site_url('musrenbang/desa/sync_preview/'.$jenis_.'/'.$tahun_.'/'.$tipe_.'/'.$kecamatan_.'/'.$deskel_);?>" class="form-horizontal" method="post" enctype="multipart/form-data">
								<div class="form-body">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-12">
											<div class="row">											
												<div class="col-md-offset-1 col-md-12">
													<a href="<?php echo site_url('musrenbang/desa/export_do/'.$jenis_.'/'.$tahun_.'/'.$tipe_.'/'.$kecamatan_.'/'.$deskel_);?>" class="btn green"> <i class="fa fa-check"></i> Proses</a>
													<a href="<?php echo site_url('musrenbang/desa/sync');?>" class="btn default"> <i class="fa fa-reply"></i> Kembali</a>
												</div>
											</div>
										</div>
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('musrenbang/desa/tampil_combobox_deskel_by_kecamatan4/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	...
	function show_form_pagedata(){
		...
		load('musrenbang/desa/tampil_combobox_pagedata/'+jenis+'/'+tahun+'/'+tipe, '#tampil_combobox_pagedata');
	}
	...
	function proses_sync_all(){
		...
		if ($jenis_ == 1){
			...
			if (confirm('Apakah Anda yakin akan memproses sinkronisasi ini?\nData kegiatan Tahun <?php echo $tahun_; ?> Jenis <?php echo $tipe_nama; ?> yang ada di RKPD Offline akan digantikan dengan data dari RKPD Online')) {
				sync_data("#btnsync_all", "<?php echo site_url('musrenbang/desa/sync_do_'); ?>", "<?php echo $jenis_; ?>", "<?php echo $tahun_; ?>", "<?php echo $tipe_; ?>", "semua");
			}
			<?php
		} else if ($jenis_ == 2){
			?>
	...
	function proses_sync_part(){
		if (confirm('Apakah Anda yakin akan memproses sinkronisasi ini?')) {
			sync_data("#btnsync_part", "<?php echo site_url('musrenbang/desa/sync_do_'); ?>", "<?php echo $jenis_; ?>", "<?php echo $tahun_; ?>", "<?php echo $tipe_; ?>", "sebagian");
		}
	}
	</script>