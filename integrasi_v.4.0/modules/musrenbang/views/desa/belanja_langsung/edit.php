<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Ubah Hasil Musrenbang Desa <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form hasil musrenbang desa ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-pencil"></i>Ubah Hasil Musrenbang Desa
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/desa/update/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
												<div class="row">
													<div class="col-md-3">
                                                ...
                                                <div class="row">
													...
													<div class="col-md-6">
														<div class="form-group" id="tampil_combobox_deskel_by_kecamatan">
															<label class="control-label" for="deskel_kode">Desa <span class="required">*</span></label>
															<?php
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															if ($file){
																?>
																<div class="form-control-static" id="preview-file-btl" style="display:block;width:100%;"><a href="<?php echo site_url("musrenbang/desa/previewfile/".$kode)?>" target="_blank">Preview</a>&nbsp;<i class="fa fa-times" id="remove-file" class="remove-file" title="Remove" style="cursor:pointer;">&nbsp;</i></div>
																<?php
															} else {
																?>
												...
												<div class="row">
                                                	...
                                                	<div class="col-md-2 box-image">
														...
														<?php if ($photo != ""){ ?>
														<div id="photo-preview<?php echo $i; ?>" class="photo-preview" style="display: block;overflow:hidden"><img src="<?php echo base_url('public/uploads/pictures/musrenbang_desa/'.$photo); ?>" id="img-preview<?php echo $i; ?>" style="width:100%;height:auto;" /></div>
	...
	function show_form_urusan_by_skpd(){
		...
		load('musrenbang/desa/tampil_combobox_urusan_by_skpd/'+skpd_kode, '#tampil_combobox_urusan_by_skpd');
		load('musrenbang/desa/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	
	function show_form_program_by_urusan(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var urusan_kode = $('select[name=urusan_kode]').val();
		load('musrenbang/desa/tampil_combobox_program_by_urusan/'+skpd_kode+'/'+urusan_kode, '#tampil_combobox_program_by_urusan');
	}
	
	function show_form_deskel_by_kecamatan(){
		var kecamatan_kode = $('select[name=kecamatan_kode]').val();
		load('musrenbang/desa/tampil_combobox_deskel_by_kecamatan2/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	...
	function show_nomor(){
		...
		load('musrenbang/desa/cek_nomor_kegiatan/'+token+'/'+tahun+'/'+tipe+'/'+nomor+'/<?php echo $nomor; ?>', '#show_nomor');
	}
	</script>