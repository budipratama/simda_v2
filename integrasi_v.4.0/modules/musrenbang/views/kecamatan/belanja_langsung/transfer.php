<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Transfer Hasil Musrenbang Kecamatan <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form transfer hasil musrenbang kecamatan ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-paper-plane"></i>Transfer Hasil Musrenbang Kecamatan
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kecamatan/doTransfer/bl/'.$kode.'/'.$nomor_);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
												...
												<div class="row">
                                                	...
                                                	<div class="col-md-9">
														<div class="form-group">
                                                            ...
                                                            <!-- combobox('jenis=db,1d,2d', 'array', 'name', 'value', 'value_name', 'selected', 'js', 'label', 'script') -->
															<?php combobox('db', $skpd, 'skpd_kode', 'skpd_kode', 'skpd_nama', $skpd_, 'show_form_urusan_by_skpd();', 'Pilih SKPD Pelaksana', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
														</div>
													</div>
													<!--/span-->
                                                </div>    
												...
												<div class="row">
                                                	<div class="col-md-12">
														<div class="form-group" id="tampil_combobox_misi_by_skpd">
															...
															<?php combobox('db', $misi, 'misi_kode', 'misi_kode', 'misi_nama', '', 'show_form_tujuan_by_misi();', 'Pilih Misi', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
														</div>
													</div>
													<!--/span-->
                                                </div>
                                                ...
                                                <div class="row">
                                                	<div class="col-md-6">
														<div class="form-group" id="tampil_combobox_urusan_by_indikator">
															...
															<?php combobox('db', $urusan, 'urusan_kode', 'urusan_kode', 'urusan_nama', $urusan_, 'show_form_program_by_indikator();', 'Pilih Urusan', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
														</div>
													</div>
													<!--/span-->
                                                	<div class="col-md-6">
														<div class="form-group" id="tampil_combobox_program_by_urusan">
															...
															<?php combobox('db', $program, 'program_kode', 'program_kode', 'program_nama', $program_, '', 'Pilih Program', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
														</div>
													</div>
													<!--/span-->
                                                </div>
												...
												<h3 class="form-section">Indikator Kelurahan Kegiatan</h3>
                                                <div class="row">
                                                	<div class="col-md-12">
														<div class="form-group" id="tampil_combobox_hasil_by_program">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="total_asumsi" id="total_asumsi" value="<?php echo rupiah2($apbd_kab);?>" style="text-align:right;font-weight:bold;" placeholder="0" readonly="readonly">
														</div>
													</div>
													<!--/span-->
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                    	<div class="form-group" id="tampil_combobox_deskel_by_kecamatan">
															...
															<?php combobox('db', $deskel, 'deskel_kode', 'skpd_kd', 'skpd_nama', $deskel_, '', 'Pilih Kelurahan', 'class="select2_category form-control"'); ?>
														</div>
                                                    </div>
                                                    <!--/span-->
                                                </div>
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															if ($file){
																?>
																<div class="form-control-static" id="preview-file-bl" style="display:block;width:100%;"><a href="<?php echo site_url("musrenbang/kecamatan/previewfile/".$kode)?>" target="_blank">Preview</a>&nbsp;</div>
																<?php
															} else {
																?>
												...
												<div class="row">
                                                	...
                                                	<div class="col-md-2 box-image">
														...
														<?php if ($photo != ""){ ?>
														<div id="photo-preview<?php echo $i; ?>" class="photo-preview" style="display: block;overflow:hidden"><img src="<?php echo base_url('public/uploads/pictures/musrenbang_kecamatan/'.$photo); ?>" id="img-preview<?php echo $i; ?>" style="width:100%;height:auto;" /></div>
	...
	function show_form_misi_by_skpd(){
		...
		load('musrenbang/kecamatan/tampil_combobox_misi_by_skpd/'+skpd_kode, '#tampil_combobox_misi_by_skpd');
	}
	
	function show_form_tujuan_by_misi(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var misi_kode = $('select[name=misi_kode]').val();
		load('musrenbang/kecamatan/tampil_combobox_tujuan_by_misi/'+skpd_kode+'/'+misi_kode, '#tampil_combobox_tujuan_by_misi');
	}
	
	function show_form_sasaran_by_tujuan(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var tujuan_kode = $('select[name=tujuan_kode]').val();
		load('musrenbang/kecamatan/tampil_combobox_sasaran_by_tujuan/'+skpd_kode+'/'+tujuan_kode, '#tampil_combobox_sasaran_by_tujuan');
	}
	
	function show_form_indikator_by_sasaran(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var sasaran_kode = $('select[name=sasaran_kode]').val();
		load('musrenbang/kecamatan/tampil_combobox_indikator_by_sasaran/'+skpd_kode+'/'+sasaran_kode, '#tampil_combobox_indikator_by_sasaran');
	}
	...
	function show_form_urusan_by_indikator(){
		...
		load('musrenbang/kecamatan/tampil_combobox_urusan_by_indikator/'+skpd_kode+'/'+tujuan_kode+'/'+indikator_kode, '#tampil_combobox_urusan_by_indikator');
	...
	function show_nomor(){
		...
		load('musrenbang/kecamatan/cek_nomor_kegiatan_transfer/'+token+'/'+tahun+'/'+tipe+'/'+nomor, '#show_nomor');
	}	
