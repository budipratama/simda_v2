<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Ubah Hasil Musrenbang Kecamatan <small>anggaran tidak langsung</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-pencil"></i>Ubah Musrenbang Kecamatan
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kecamatan/update/btl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															if ($file){
																?>
																<div class="form-control-static" id="preview-file-btl" style="display:block;width:100%;"><a href="<?php echo site_url("musrenbang/kecamatan/previewfile/".$kode)?>" target="_blank">Preview</a>&nbsp;<i class="fa fa-times" id="remove-file" class="remove-file" title="Remove" style="cursor:pointer;">&nbsp;</i></div>
																<?php
															} else {
																?>
	...
	function show_nomor(){
		...
		load('musrenbang/kecamatan/cek_nomor_kegiatan/'+token+'/'+tahun+'/'+tipe+'/'+nomor+'/<?php echo $nomor; ?>', '#show_nomor');
	}
	</script>