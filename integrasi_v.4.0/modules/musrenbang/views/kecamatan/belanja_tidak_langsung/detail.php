<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Detail Hasil Musrenbang Kecamatan <small>anggaran belanja tidak langsung</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Data Detail Musrenbang Kecamatan
							</div>
						</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													if ($file){
														?>
														<p class="form-control-static"><a href="<?php echo site_url("musrenbang/kecamatan/previewfile/".$kode)?>" target="_blank">Preview</a></p>
														<?php
													} else {
														?>
												...
												if ($foto){
													...
													<div class="col-md-3 box-image box-image-detail">
														<div class="photo-detail" style="display:block;overflow:hidden">
															<img src="<?php echo base_url('public/uploads/pictures/musrenbang_kecamatan/'.$row)?>" alt="" style="width:100%;">
														</div>
													</div>
													<?php
													if ($i % 3 == 0 || $i == $jml_foto){
										...
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													...
													<?php if ($admin_log['level_kode'] == '1' || $admin_log['level_kode'] == '4') { ?>
													<a href="<?php echo site_url('musrenbang/kecamatan/edit/'.$kode);?>" class="btn green"><i class="fa fa-pencil"></i> Ubah</a>
													<?php } if ($admin_log['level_kode'] == '1' || $admin_log['level_kode'] == '5') { ?>
													<a href="<?php echo site_url('musrenbang/kecamatan/transfer/'.$kode);?>" class="btn blue"><i class="fa fa-paper-plane"></i> Transfer ke Rencana Kerja</a>
													<?php } ?>
												</div>
											</div>
										</div>
