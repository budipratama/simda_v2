<!-- BEGIN CONTENT -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									...
									<div class="portlet-body form" style="<?php echo (isset($formCari)?'display:none;':'')?>">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kecamatan/cari');?>" class="form-horizontal" method="post">
											<div class="form-body">
													...
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-offset-1 col-md-12">
																...
																<a href="<?php echo site_url('musrenbang/kecamatan');?>" class="btn default"> <i class="fa fa-times"></i> Bersihkan Hasil Pencarian</a>
																<div class="btn-group" style="margin-left:100px;">
																	<?php if ($skpd_aktive == 'yes') { ?>
																	...
																	<li>
																		<a href="<?php echo site_url('musrenbang/kecamatan/belanja-langsung');?>">Belanja Langsung</a>
																	</li>
																	<li>
																		<a href="<?php echo site_url('musrenbang/kecamatan/belanja-tidak-langsung');?>">Belanja Tidak Langsung</a>
																	</li>
																	</ul>
																	<?php } ?>
																</div>
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('musrenbang/kecamatan/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>