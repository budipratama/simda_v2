<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Tambah Hasil Musrenbang Kelurahan <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-pencil"></i>Tambah Hasil Musrenbang Kelurahan
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kelurahan/insert/bl');?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
													...
													<div class="col-md-6">
														<div class="form-group" id="tampil_combobox_deskel_by_kecamatan">
															...
															if ($admin_log['level_kode'] == 15){
																...
																combobox('db', $deskel, 'deskel_kode', 'skpd_kd', 'skpd_nama', '', '', 'Semua Kelurahan', 'class="select2_category form-control" tabindex="1"'); 
															} ?>
														</div>
													</div>
                                                    <!--/span-->
	...
	function show_nomor(){
		...
		load('musrenbang/kelurahan/cek_nomor_kegiatan/'+token+'/'+tahun+'/'+tipe+'/'+nomor, '#show_nomor');
	}
	</script>