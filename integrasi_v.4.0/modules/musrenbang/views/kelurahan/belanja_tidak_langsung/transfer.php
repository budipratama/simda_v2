<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Transfer Hasil Musrenbang Kelurahan <small>anggaran tidak langsung</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-paper-plane"></i>Transfer Musrenbang Kelurahan
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kelurahan/doTransfer/btl/'.$kode.'/'.$nomor_);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															if ($file){
																?>
																<div class="form-control-static" id="preview-file-bl" style="display:block;width:100%;"><a href="<?php echo site_url("musrenbang/kelurahan/previewfile/".$kode)?>" target="_blank">Preview</a>&nbsp;</div>
																<?php
															} else {
																?>
