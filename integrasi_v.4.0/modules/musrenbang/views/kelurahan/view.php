				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									...
									<div class="portlet-body form" style="<?php echo (isset($formCari)?'display:none;':'')?>">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('musrenbang/kelurahan/cari');?>" class="form-horizontal" method="post">
											<div class="form-body">
													...
													<div class="col-md-6">
														<div class="form-group" id="tampil_combobox_deskel_by_kecamatan">
															...
															<?php if ($deskel_ == 'deskel' || $deskel_ == ''){ 
																...
																if ($deskel_aktive == 'yes') { combobox('db', $deskel, 'deskel_kode', 'skpd_kd', 'skpd_nama', $deskel_, '', 'Semua Kelurahan', 'class="select2_category form-control" tabindex="1"'); 
																} else {
																echo '<select class="select2_category form-control" name="deskel_kode" id="deskel_kode" data-placeholder="Pilih Kelurahan" tabindex="1" required="required">
																<option value="'.$deskel_kode.'" selected>'.$deskel_nama.'</option>
																</select>';
													...
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-offset-1 col-md-12">
																...
																<a href="<?php echo site_url('musrenbang/kelurahan');?>" class="btn default"> <i class="fa fa-times"></i> Bersihkan Hasil Pencarian</a>
																<?php
																if ($admin_log['level_kode'] == 15){
																?>
																<div class="btn-group" style="margin-left:100px;">
																	<button type="button" class="btn blue dropdown-toggle" data-toggle="dropdown"><i class="fa fa-plus"></i> Tambah Hasil Musrenbang</button>
																	<button type="button" class="btn blue dropdown-toggle" data-toggle="dropdown"><i class="fa fa-angle-down"></i></button>
																	<ul class="dropdown-menu" role="menu">
																	<li>
																		<a href="<?php echo site_url('musrenbang/kelurahan/list-skpd/belanja-langsung');?>">Belanja Langsung</a>
																	</li>
																	<li>
																		<a href="<?php echo site_url('musrenbang/kelurahan/list-skpd/belanja-tidak-langsung');?>">Belanja Tidak Langsung</a>
																	</li>
																	</ul>
																</div>
																<a href="<?php echo site_url('musrenbang/kelurahan/sync');?>" class="btn default"> <i class="fa fa-refresh"></i> Sinkronisasi</a>
																<?php
																} else {
																?>
																<a style="margin-left:100px;" href="<?php echo site_url('musrenbang/kelurahan/sync');?>" class="btn default"> <i class="fa fa-refresh"></i> Sinkronisasi</a>
																<?php
																}
																?>
															</div>
            ...
            <div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>Daftar Hasil Musrenbang Kelurahan
							</div>
						</div>
						<script>
