...
class Murni extends CI_Controller {
		...
		$container['content']['view']						= 'rka/murni/belanja_langsung/add';			
		{
			...
			$container['content']['dataset']['tahun'] 		= $belanja->tahun;
				...
				$container = array(
					...
					'program'		=> $this->input->post('ppp_kode'),
					...
					'anggaran_bl'	=> $this->input->post('id_kode'),
					'tipe_kode'		=> 1
					);
	...
	public function belanja_langsung1()
	{
		...
		$container['content']['view']						= 'rka/murni/belanja_langsung/add';		
			...
			$insert['anggaran_bl']	 = $this->input->post('id_kode');
			//$insert['tim_anggaran']	 = $this->input->post('skpd_kode');
			$id_kode			= $this->input->post('id_kode');
			$insert['tipe_kode']= 1;
