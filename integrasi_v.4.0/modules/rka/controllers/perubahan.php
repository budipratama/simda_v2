...
class Perubahan extends CI_Controller {
	...
	function datatable()
	{
		...
		if ($skpd == 'skpd' && $kecamatan == 'kecamatan' && $deskel == 'deskel'){
			$where_datatable = 'anggaran.tahun = \''.$tahun.'\' AND anggaran.tahapan_kode = \''.$tahapan.'\' AND anggaran.tipe_kode = \''.$tipe.'\' AND anggaran.perubahan_status_kode = \''.$status.'\' AND anggaran.kegiatan LIKE \'%'.$key.'%\'';
		} else if ($kecamatan == 'kecamatan' && $deskel == 'deskel'){
			$where_datatable = 'anggaran.tahun = \''.$tahun.'\' AND anggaran.tahapan_kode = \''.$tahapan.'\' AND anggaran.tipe_kode = \''.$tipe.'\' AND anggaran.perubahan_status_kode = \''.$status.'\' AND anggaran.pelaksana_kode = \''.$skpd.'\' AND anggaran.kegiatan LIKE \'%'.$key.'%\'';
		} else if ($skpd == 'skpd' && $deskel == 'deskel'){
			$where_datatable = 'anggaran.tahun = \''.$tahun.'\' AND anggaran.tahapan_kode = \''.$tahapan.'\' AND anggaran.tipe_kode = \''.$tipe.'\' AND anggaran.perubahan_status_kode = \''.$status.'\' AND anggaran.kecamatan_kode = \''.$kecamatan.'\' AND anggaran.kegiatan LIKE \'%'.$key.'%\'';
		} else if ($deskel == 'deskel'){
			$where_datatable = 'anggaran.tahun = \''.$tahun.'\' AND anggaran.tahapan_kode = \''.$tahapan.'\' AND anggaran.tipe_kode = \''.$tipe.'\' AND anggaran.perubahan_status_kode = \''.$status.'\' AND anggaran.pelaksana_kode = \''.$skpd.'\' AND anggaran.kecamatan_kode = \''.$kecamatan.'\' AND anggaran.kegiatan LIKE \'%'.$key.'%\'';
		} else {
			$where_datatable = 'anggaran.tahun = \''.$tahun.'\' AND anggaran.tahapan_kode = \''.$tahapan.'\' AND anggaran.tipe_kode = \''.$tipe.'\' AND anggaran.perubahan_status_kode = \''.$status.'\' AND anggaran.pelaksana_kode = \''.$skpd.'\' AND anggaran.kecamatan_kode = \''.$kecamatan.'\' AND anggaran.deskel_kode = \''.$deskel.'\' AND anggaran.kegiatan LIKE \'%'.$key.'%\'';
		}
	...
	function get_buttons($tipe, $id)
	{
		...
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/perubahan/detail/'.$id) .'" class="btn btn-sm btn-info" title="Detail"><i class="fa fa-file-text"></i></a>';
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/perubahan/belanja/'.$id) .'" class="btn btn-sm btn-success" title="Tambah"><i class="fa fa-pencil"></i></a>';
		$html .= '<a href="'. site_url($ci->uri->segment(1) . '/perubahan/delete/'.$id) .'" class="btn btn-sm btn-danger" title="Delete" data-placement="left" onclick="return confirm(\'Apakah anda yakin? \nAkan menghapus data rencana kerja ini.\');"><i class="fa fa-trash-o"></i></a>';
		$html .= '</div>';
		return $html;
	}
	...
	public function index()
	{
		...
		$container['sidebar']['dataset']['aktive_menu'] = 50;
		$container['content']['view']					= 'rka/perubahan/view';
	...
	public function cari()
	{
		...
		redirect('rka/perubahan/hasil-pencarian/'.$tahun.'/'.$tipe.'/'.$skpd.'/'.$kecamatan.'/'.$deskel.'/'.$kegiatan);
	}
	...
	public function detail()
	{
		...
		if ($anggaran->tipe_kode == 1){
			...
			$container['content']['view']					= 'rka/perubahan/belanja_langsung/detail';
			...
			$container['content']['view']					= 'rka/perubahan/belanja_tidak_langsung/detail';
	...
	public function delete()
	{
		...
		if ($waktuEntri->selesai < $waktuSekarang && $tahapanSKPD == 0 && $admin_log['level_kode'] != 1){
			redirect('rka/perubahan/#warningEntri', 'refresh');
		} else {
			$kode 		= $this->uri->segment(4);
			...
			if ($anggaran->status == 1){
				...
				redirect('rka/perubahan/#successDelete', 'refresh');
				
			} else {
				
				redirect('rka/perubahan/#warningTransfer', 'refresh');
			}

			redirect('rka/perubahan', 'refresh');
		}
	}
	...
	public function belanja()
	{
		...
		if ($anggaran->tipe_kode == 1){			
			...
			$container['content']['view']					= 'rka/perubahan/belanja_langsung/belanja';
			$container['content']['dataset']['kode'] 		= $anggaran_bl->kode;
			$container['content']['dataset']['tahun'] 		= $anggaran_bl->tahun;
			$container['content']['dataset']['skpd'] 		= $anggaran_bl->skpd_nama;
			$container['content']['dataset']['visi'] 		= $anggaran_bl->visi_nama;
			...
			$anggaran_btl									= $this->Anggaran_model->get('2','anggaran.kode, anggaran.tahun, anggaran.kegiatan, anggaran.catatan, anggaran.proposal, anggaran.verifikasi, anggaran.foto, anggaran.koordinat, kecamatan.skpd_nama as kecamatan_nama, deskel.skpd_nama as deskel_nama, anggaran.alamat, anggaran.rt, , anggaran.rw, anggaran_btl.volume, anggaran_btl.biaya, anggaran_btl.penerima, pelaksana.skpd_nama', array('anggaran.kode'=>$kode));
			$container['content']['view']					= 'rka/perubahan/belanja_tidak_langsung/belanja';
			$container['content']['dataset']['kode'] 		= $anggaran_btl->kode;
			$container['content']['dataset']['tahun'] 		= $anggaran_btl->tahun;
			$container['content']['dataset']['skpd'] 		= $anggaran_btl->skpd_nama;
			$container['content']['dataset']['kegiatan'] 	= $anggaran_btl->kegiatan;
	...
	public function belanja_langsung() {
		...
		$this->form_validation->set_rules('no_kode', 'No', 'trim|required|xss_clean');        		
		{
			...
			$container['sidebar']['view']						= 'admin/sidebar';
			$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
			$container['content']['view']						= 'rka/perubahan/belanja_langsung/add';		
			...
			$container['content']['dataset']['kegiatan'] 	= $belanja->kegiatan;
				...
				if($this->Rka_model->insert($container)){
				   ...
				   redirect('rka/perubahan/belanja/'.$id_kode);
				}
			}
		}
    }
	
	public function belanja_langsung1()
	{
		$admin_log 	= $this->auth->is_login_admin();
		$kode 		= $this->uri->segment(4);
		$anggaran 	= $this->Anggaran_model->getOnly('tipe_kode', array('kode'=>$kode));		
		...
		$this->form_validation->set_rules('eee_kode', 'Rincian', 'trim|required|xss_clean');
		$this->form_validation->set_rules('sss_kode', 'Sumber', 'trim|required|xss_clean');
		$this->form_validation->set_rules('ppp_kode', 'Program', 'trim|required|xss_clean');
		$this->form_validation->set_rules('thn_kode', 'Tahun', 'trim|required|xss_clean');
		...
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/add';		
			...
			$belanja										= $this->Anggaran_model->get('1','anggaran.kode, anggaran.skpd_kode, anggaran.tahun, anggaran.kegiatan, anggaran.catatan, anggaran.proposal, anggaran.verifikasi, anggaran.foto, anggaran.koordinat, kecamatan.skpd_nama as kecamatan_nama, deskel.skpd_nama as deskel_nama, anggaran.alamat, anggaran.rt, , anggaran.rw, anggaran_bl.urutan, anggaran_bl.apbd_kab, anggaran_bl.apbd_prov, anggaran_bl.apbn, anggaran_bl.sumberlain, anggaran_bl.perkiraan_maju, anggaran_bl.hp_ukur, anggaran_bl.hp_target, anggaran_bl.hp_satuan, sifat.sifat_nama, kesepakatan.nama as kesepakatan_nama, pelaksana.skpd_nama, visi.visi as visi_nama, misi.misi as misi_nama, prioritas.prioritas as prioritas_nama, tujuan.tujuan as tujuan_nama, sasaran.sasaran as sasaran_nama, indikator.indikator as indikator_nama, urusan.urusan as urusan_nama, program.kode as program_nama, anggaran_bl.kh_ukur, anggaran_bl.kh_target, anggaran_bl.kh_satuan, anggaran_bl.hk_ukur, anggaran_bl.hk_target, anggaran_bl.hk_satuan', array('anggaran.kode'=>$kode));
			$container['content']['dataset']['kode'] 		= $belanja->kode;
			$container['content']['dataset']['program'] 	= $belanja->program_nama;
			$container['content']['dataset']['skpd'] 		= $belanja->skpd_kode;
			$container['content']['dataset']['tahun'] 		= $belanja->tahun;
		} else {			
			...
			$insert['sumber']	= $this->input->post('sss_kode');
			$insert['program']	= $this->input->post('ppp_kode');
			$insert['tahun']	= $this->input->post('thn_kode');
			$insert['skpd'] 	= $this->input->post('skpd_kode');
			$insert['no'] 		= $this->input->post('no_kode');
			$insert['anggaran_kode'] = $this->input->post('id_kode');
			$id_kode			= $this->input->post('id_kode');
			$insert['tipe_kode']= 1;
			
			$query = $this->Rka_model->insert($insert);			
			$this->session->set_flashdata('success','<div class="alert alert-success fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Success!</strong> Data "BELANJA" baru telah berhasil ditambahkan.</div>');
			redirect('rka/perubahan/belanja/'.$id_kode);
		}
	...
	public function edit($id) {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/edit';
			...
			redirect('rka/perubahan/belanja/'.$id_kode, 'refresh');
			}
		}
    }
	...
	public function deleteb() {
		...
		$rka 		= $this->Rka_model->getOnly('anggaran_kode', array('kode'=>$kode));			
			...
			redirect('rka/perubahan/belanja/'.$rka->anggaran_kode, 'refresh');
		}
	}
	...
	public function rincian() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/rincian';		
	...
	public function addr() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/addr';
			...
			redirect('rka/perubahan/rincian/'.$id_kode);
		}
	...
	public function editr($id) {
		...
		$this->form_validation->set_rules('aaa_kode','Uraian','trim|xss_clean');
			...
			if($this->form_validation->run() == FALSE){	
				$container['sidebar']['view']						= 'admin/sidebar';
				$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
				$container['content']['view']						= 'rka/perubahan/belanja_langsung/editr';
			...
			redirect('rka/perubahan/rincian/'.$id_kode, 'refresh');
			}
		}
    }
	...
	public function deleter() {
		$admin_log 	= $this->auth->is_login_admin(); {
			...
			redirect('rka/perubahan/rincian/'.$rincian->rka, 'refresh');
		}
	}
	...
	public function sub() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/sub';		
	...
	public function adds($list_id = null) {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/adds';
			...
			redirect('rka/perubahan/sub/'.$id_kode);
		}
	...
	public function edits($id) {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 50;	
		$container['content']['view']						= 'rka/perubahan/belanja_langsung/edits';
		...
		$container['sub']									= $this->Rka_model->get_sub($kode);
			...
			$this->session->set_flashdata('success','<div class="alert fresh-color alert-warning fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Success!</strong> Data "RINCIAN BELANJA" telah berhasil diubah</div>');
			redirect('rka/perubahan/sub/'.$id_kode, 'refresh');
			}
		}
    }
	...
	public function deletes() {
		$admin_log 	= $this->auth->is_login_admin(); {
			...
			redirect('rka/perubahan/sub/'.$sub->rka_rincian, 'refresh');
		}
	}
	...
	public function view() {
		$admin_log 	= $this->auth->is_login_admin();
		{
			$container['sidebar']['view']					= 'admin/sidebar';
			$container['sidebar']['dataset']['aktive_menu'] = 50;
			$container['content']['view']					= 'rka/perubahan/belanja_langsung/view';
	...
	public function preview() {	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 50;
		$container['content']['view']					= 'rka/perubahan/belanja_langsung/preview';
		$header['admin_log']							= $admin_log;
	...
	public function hasil() {	
		...
		$this->load->view('rka/perubahan/belanja_langsung/hasil', $laporan);
	}
	...
	public function tim() {
		$admin_log 	= $this->auth->is_login_admin();
		{
			$container['sidebar']['view']					= 'admin/sidebar';
			$container['sidebar']['dataset']['aktive_menu'] = 50;
			$container['content']['view']					= 'rka/perubahan/belanja_langsung/tim';
	...
	public function transfer_perubahan() {
		$admin_log 	= $this->auth->is_login_admin();
		$waktuEntri	= $this->Tahapan_model->get('selesai', array('kode' => '17'));
		$tahapanSKPD = $this->Tahapan_skpd_model->count_all(array('skpd_kode' => $admin_log['skpd_kode'], 'tahapan_kode' => '17'));
		$waktuSekarang = date("Y-m-d H:i:s");
		if ($waktuEntri->selesai < $waktuSekarang && $tahapanSKPD == 0 && $admin_log['level_kode'] != 1){
			...
			if ($anggaran->status == 1){
				...
				if ($anggaran->tipe_kode == 1){
					...
					$container['content']['view']					= 'rka/perubahan/belanja_langsung/perubahan';
					if ($admin_log['level_kode'] == 5 || $admin_log['level_kode'] == 4){
						$skpd = $this->Skpd_model->get('skpd_kode, skpd_nama', array('skpd_kode' => $admin_log['skpd_kode']));
						$container['content']['dataset']['skpd_kode']	= $skpd->skpd_kode;
						$container['content']['dataset']['skpd_nama']	= $skpd->skpd_nama;
					...
					$container['content']['view']					= 'rka/murni/belanja_tidak_langsung/perubahan';
					$container['content']['dataset']['kode'] 		= $anggaran_btl->kode;
		...
		if ($type == 'bl'){
			...
			if($this->form_validation->run() == FALSE) {
				...
				if ($this->input->post('apbd_kab') <= $sisa_anggaran){
					...
					$insert['sumber_kode']		= 4;
					$insert['sumber_id']		= $kode;
					$insert['tahapan_kode']		= 17;
					...
					$this->Anggaran_model->update('anggaran', array('status'=>'2', 'tahapan_kode'=>'17', 'perubahan_id'=>$kode, 'perubahan_status_kode'=>'1'), array('kode'=>$kode)); // Update Sumber Anggaran
			...
			if($this->form_validation->run() == FALSE) {
				$container['sidebar']['view']					= 'admin/sidebar';
				$container['sidebar']['dataset']['aktive_menu'] = 46;
	...
	public function belanja_tidak_langsung()
	{
		...
		if ($waktuEntri->selesai < $waktuSekarang && $tahapanSKPD == 0 && $admin_log['level_kode'] != 1){
			...
			$container['sidebar']['view']					= 'admin/sidebar';
			$container['sidebar']['dataset']['aktive_menu'] = 50;
			$container['content']['view']					= 'rka/perubahan/belanja_tidak_langsung/add';
			$container['content']['dataset']['tahun']		= $this->Tahun_model->grid_all('tahun', 'tahun', 'ASC', '', '', array('status'=>'1'));
			$container['content']['dataset']['skpd']		= $this->Skpd_model->grid_all('skpd_kode, skpd_nama', 'skpd_nama', 'ASC', '', '', array('skpd_status'=>'SKPD'));
			$container['content']['dataset']['kecamatan']	= $this->Skpd_model->grid_all('skpd_kd, skpd_nama', 'skpd_nama', 'ASC', '', '', array('skpd_status'=>'Kecamatan'));
			$header['admin_log']							= $admin_log;
		...
		if ($waktuEntri->selesai < $waktuSekarang && $tahapanSKPD == 0 && $admin_log['level_kode'] != 1){
			...
			if ($anggaran->status == 1){
				...
				if ($anggaran->tipe_kode == 1){
					...
					$container['content']['view']					= 'rka/perubahan/belanja_langsung/transfer';
					if ($admin_log['level_kode'] == 5 || $admin_log['level_kode'] == 4){
						$skpd = $this->Skpd_model->get('skpd_kode, skpd_nama', array('skpd_kode' => $admin_log['skpd_kode']));
						$container['content']['dataset']['skpd_kode']	= $skpd->skpd_kode;
						$container['content']['dataset']['skpd_nama']	= $skpd->skpd_nama;
					...
					$container['content']['view']					= 'rka/perubahan/belanja_tidak_langsung/transfer';
					$container['content']['dataset']['kode'] 		= $anggaran_btl->kode;
					$container['content']['dataset']['tahun_'] 		= $anggaran_btl->tahun;
					$container['content']['dataset']['skpd_'] 		= $anggaran_btl->pelaksana_kode;
					$container['content']['dataset']['kegiatan'] 	= $anggaran_btl->kegiatan;
		...
		if ($type == 'bl'){
			...
			if($this->form_validation->run() == FALSE)
			{
				...
				if ($this->input->post('apbd_kab') <= $sisa_anggaran){
					...
					redirect('rka/perubahan/#successTransfer', 'refresh');
				} else {
					redirect('rka/perubahan/#warningAPBD', 'refresh');
				}
