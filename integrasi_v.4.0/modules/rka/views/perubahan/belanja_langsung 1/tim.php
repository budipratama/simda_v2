				...
				<input type="hidden" name="kode" value="<?php echo $kode; ?>" />	
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-1">
							<input type="text" class="form-control" name="aaa_kode" id="aaa_kode" maxlength="1" onkeypress="return isNumberKey(event)" value="<?php echo $aaa_kode;?>" readonly="readonly">
							</div>
