                        ...
                        <div class="body">
							...
							<h3 class="form-section"><b>Asumsi Biaya Pendanaan</b></h3>
								...
								<div class="btn-group" style="margin-left:100px;">
									<a href="<?php echo site_url('rka/murni/penyedia/'.$kode);?>" class="btn btn-info">Tambah RUP Penyedia</a>
								</div>
								<div class="btn-group" style="margin-left:50;">
									<a href="<?php echo site_url('rka/murni/swakelola/'.$kode);?>" class="btn btn-success">Tambah RUP Swakelola</a>
								</div>
                            </form>
							</div>
							</div>
