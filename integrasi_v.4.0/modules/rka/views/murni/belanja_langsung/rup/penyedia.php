							...
							<input type="hidden" class="form-control" name="id_paket" id="id_paket" value="1">
								...
								<div class="row clearfix">
									<div class="col-md-3">
										...
										<div class="form-group form-float">
											<div class="form-line">										
											<?php combobox('db', $sumber, 'sumber_kode', 'kode', 'jenis_nama', '', 'show_form_asal_by_sumber();', 'Pilih ...', 'class="form-control show-tick" data-live-search="true" tabindex="1" required="required"');?>
											</div>								
										</div>								
									</div>
									<div class="col-md-8">
										<div class="form-group form-float" id="tampil_combobox_asal_by_sumber">							
										</div>								
									</div>
								</div>
								<div class="row clearfix">
								...
								<div class="row clearfix">
									<div class="col-md-4">
										...
										<div class="form-group form-float">
											<div class="form-line">										
											<?php combobox('db', $metode, 'metode_kode', 'kode', 'metode_nama', '', '', 'Pilih ...', 'class="form-control show-tick" data-live-search="true" tabindex="1" required="required"');?>
											</div>
										</div>
									</div>
									...
									<p><b>Awal :</b></p>
										<div class="form-group form-float">
											<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" name="pm_awal" id="pm_awal" required="required" readonly>
									...
									<p><b>Akhir :</b></p>
										<div class="form-group form-float">
											<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" name="pm_akhir" id="pm_akhir" required="required" readonly>
												<span class="input-group-btn"><button class="btn default" type="button"><i class="material-icons">today</i></button></span>
											</div>
										</div>
									</div>
								...
								<div class="row clearfix">									
									...
									<p><b>Awal :</b></p>
										<div class="form-group form-float">
											<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" name="pk_awal" id="pk_awal" required="required" readonly>
												<span class="input-group-btn"><button class="btn default" type="button"><i class="material-icons">today</i></button></span>
											</div>
										</div>
									</div>
									...
									<p><b>Akhir :</b></p>
										<div class="form-group form-float">
											<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" name="pk_akhir" id="pk_akhir" required="required" readonly>
												<span class="input-group-btn"><button class="btn default" type="button"><i class="material-icons">today</i></button></span>
											</div>
										</div>
									</div>
...
<!-- #END# Multiple Items To Be Open -->	
  <!-- END CONTENT -->
<script>
	function show_form_asal_by_sumber(){
		var sumber_kode = $('select[name=sumber_kode]').val();
		load('rka/murni/tampil_combobox_asal_by_sumber/'+sumber_kode, '#tampil_combobox_asal_by_sumber');
	}
</script>