		...
		<h2>RKA Murni<small> anggaran belanja langsung</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					...
					<li class="active"> Add RUP Swakelola</li>
				</ol>
			</div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						<div class="header"><h2>Tambah Rencana Umum Pengadaan <small>Paket Swakelola</small></h2></div>
                        <div class="body">
                            <div class="row clearfix">
							<div class="body">
							<form action="<?php echo site_url('rka/murni/addSwakelola/bl/'.$kode);?>" id="form_validation" enctype="multipart/form-data" method="post">
