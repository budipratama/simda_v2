                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a title="Kembali" href="<?php echo base_url(); ?>rka/murni/belanja/<?php echo $kode;?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<form action="<?php echo site_url('rka/murni/belanja-langsung');?>" id="form_validation" enctype="multipart/form-data" method="POST">
												<input type="input" value="<?php printf( "%01d", $bl->no++ ); ?>" />
												<input type="input" name="no_kode" id="no_kode" value="<?php printf( "%01d", $bl->no ); ?>" />
												<input type="input" name="id_kode" id="id_kode" value="<?php echo $kode;?>" />
												<input type="input" name="program_kode" id="program_kode" value="<?php echo $program;?>" />
												<input type="input" name="thn_kode" id="thn_kode" value="<?php echo $tahun;?>" />
												<input type="input" name="skpd_kode" id="skpd_kode" value="<?php echo $skpd;?>" />				
												<input type="input" name="urusan_kode" id="urusan_kode" value="<?php echo $urusan;?>" />
											<div class="row clearfix">
												<div class="col-md-6">
											...
											<div class="form-group">
												<div class="col-md-offset-9">
													...
													<a href="<?php echo base_url(); ?>rka/murni/belanja/<?php echo $kode;?>" class="btn btn-default">Batal</a>
												</div>
											</div>
											</form>
											</div>
