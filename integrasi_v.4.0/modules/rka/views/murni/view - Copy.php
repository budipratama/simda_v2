<!-- Main Content -->   
   <section class="content">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data <font color="green"><strong>"RKA Murni"</strong></font> telah berhasil dihapus !</font>
				</div>
	...
	<a href="#successPenyedia" data-toggle="modal"></a>
	<div id="successPenyedia" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Success!</strong> Transfer RKA Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"RKA Murni"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"RUP Penyedia"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<a href="#successSwakelola" data-toggle="modal"></a>
	<div id="successSwakelola" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
				...
				<div class="modal-body">
					 Data <font color="green"><strong>"RKA Murni"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"RUP Swakelola"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Transfer RKA Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"RKA Murni"</strong></font> sudah ditransfer ke <font color="blue"><strong>"RUP"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
