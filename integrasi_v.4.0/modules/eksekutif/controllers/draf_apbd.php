...
class Draf_apbd extends CI_Controller {
	...
	public function index()
	{
		...
		$container['sidebar']['dataset']['aktive_menu'] = 39;
		$container['content']['view']					= 'eksekutif/draf_apbd/view';
	...
	public function cari()
	{
		...
		redirect('eksekutif/draf_apbd/hasil-pencarian/'.$tahun.'/'.$tipe.'/'.$skpd.'/'.$kecamatan.'/'.$deskel.'/'.$kegiatan);
	}
