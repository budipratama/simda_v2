...
class Musrenbang_kecamatan extends CI_Controller {
	...
	public function index()
	{
		...
		$container['sidebar']['dataset']['aktive_menu'] = 40;
		$container['content']['view']					= 'eksekutif/musrenbang/kecamatan/view';
	...
	public function cari()
	{
		...
		redirect('eksekutif/musrenbang-kecamatan/hasil-pencarian/'.$tahun.'/'.$tipe.'/'.$skpd.'/'.$kecamatan.'/'.$deskel.'/'.$kegiatan);
	}
	...
	public function detail()
	{
		...
		if ($anggaran->tipe_kode == 1){
			...
			$container['content']['view']					= 'eksekutif/musrenbang/kecamatan/detail_btl';
