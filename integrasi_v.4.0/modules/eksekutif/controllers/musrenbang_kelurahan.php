...
class Musrenbang_kelurahan extends CI_Controller {
	...
	public function index()
	{
		...
		$container['sidebar']['dataset']['aktive_menu'] = 43;
		$container['content']['view']					= 'eksekutif/musrenbang/kelurahan/view';
	...
	public function cari()
	{
		...
		redirect('eksekutif/musrenbang-kelurahan/hasil-pencarian/'.$tahun.'/'.$tipe.'/'.$skpd.'/'.$kecamatan.'/'.$deskel.'/'.$kegiatan);
	}
	...
	public function detail()
	{
		...
		if ($anggaran->tipe_kode == 1){
			...
			$container['content']['view']					= 'eksekutif/musrenbang/kelurahan/detail';
			...
			$container['content']['view']					= 'eksekutif/musrenbang/kelurahan/detail_btl';
