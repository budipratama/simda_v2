...
class Kuappas extends CI_Controller {
	...
	public function index()
	{
		...
		$container['sidebar']['dataset']['aktive_menu'] = 38;
		$container['content']['view']					= 'eksekutif/kuappas/view';
	...
	public function cari()
	{
		...
		redirect('eksekutif/kuappas/hasil-pencarian/'.$tahun.'/'.$tipe.'/'.$skpd.'/'.$kecamatan.'/'.$deskel.'/'.$kegiatan);
	}
