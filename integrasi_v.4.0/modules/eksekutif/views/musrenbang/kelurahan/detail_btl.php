<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Detail Hasil Musrenbang Kelurahan <small>anggaran belanja tidak langsung</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('eksekutif/musrenbang-kelurahan');?>">Musrenbang Kelurahan</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
							...
							<form class="form-horizontal" role="form">							
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-6" for="deskel">Kelurahan :</label>
												<div class="col-md-6">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													if ($file){
														?>
														<p class="form-control-static"><a href="<?php echo site_url("eksekutif/musrenbang-kelurahan/previewfile/".$kode)?>" target="_blank">Preview</a></p>
														<?php
													} else {
														?>
