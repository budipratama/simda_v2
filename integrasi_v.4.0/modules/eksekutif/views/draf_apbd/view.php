<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Draf Eksekutif APBD <small>informasi data rencana kerja pembangunan daerah</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('eksekutif/draf_apbd');?>">Draf Eksekutif APBD</a>
					</li>
				</ul>
			</div>
            <!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-search"></i>Pencarian Draf Eksekutif APBD
										</div>
										<div class="tools">
									...
									<div class="portlet-body form" style="<?php echo (isset($formCari)?'display:none;':'')?>">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('eksekutif/draf_apbd/cari');?>" class="form-horizontal" method="post">
											<div class="form-body">
													...
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-offset-1 col-md-12">
																...
																<a href="<?php echo site_url('eksekutif/draf-apbd');?>" class="btn default"> <i class="fa fa-times"></i> Bersihkan Hasil Pencarian</a>
															</div>
														</div>
													</div>
													<div class="col-md-6">
            ...
            <div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>Daftar Draf Eksekutif APBD
							</div>
						</div>
						<script>
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('eksekutif/draf_apbd/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>