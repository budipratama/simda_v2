                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<form action="<?php echo site_url('rka/murni/preview/'.$kode);?>" id="form_validation" class="horizontal-form" method="post">
												...
												<div class="form-group">
													<div class="col-md-offset-9">
														...
														<a href="<?php echo site_url('rka/murni/belanja/'.$kode);?>" class="btn default">Kembali</a>
													</div>
												</div>
											</form>
											</div>
