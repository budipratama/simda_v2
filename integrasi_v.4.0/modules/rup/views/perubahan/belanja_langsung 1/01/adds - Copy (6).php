		...
		<div class="row">
			...
			<?php if ($this->session->flashdata('success')) { echo $this->session->flashdata('success');} ?>
				...
				<div class="panel panel-default">
					...
					<p align="center"><b><?php echo strtoupper($rka->id_skpd);?></b></p>
						<p class="control-label col-md-10">Sub Rincian : <?php echo $bls->uraian; ?></p><p align="right"><?php $angka = $sum; $desimal ="2"; $koma =","; $titik ="."; echo "Rp. ".number_format($angka, $desimal, $koma, $titik); ?></p>
					</div>
				</div>									
				</div>
			<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<form action="<?php echo site_url('rka/murni/adds');?>" class="form-horizontal" method="post" name="autoSumForm"><br>
					<input type="hidden" value="<?php printf( "%01d", $bls->no++ ); ?>" />
					<input type="input" name="id_kode" id="id_kode" value="<?php echo $rincian->task_id; ?>" />
					<input type="input" name="rincian_kode" id="id_kode" value="<?php echo $rincian->anggaran_kode; ?>" />
						...
						<div class="form-group" id="">
							...
							<div class="col-md-5">
							<input type="text" class="form-control" name="h_satuan" maxlength="16" id="satuan" style="text-align:right;" onkeypress="return isNumber(event)" onkeyup="totalSum()" placeholder="0" required="required">
							</div>
						</div>
						</div>
					</div>				
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
							<input type="input" class="form-control" name="bbb_kode" maxlength="40" id="userInput1" onkeyup="showMsg()" placeholder="-">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
							<input type="input" class="form-control" name="ccc_kode" maxlength="40" id="userInput2" onkeyup="showMsg()" placeholder="-">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
							<input type="input" class="form-control" name="ddd_kode" maxlength="40" id="userInput3" onkeyup="showMsg()" placeholder="-">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group" id="">
							...
							<input type="text" class="form-control" name="thirdBox" style="text-align:right;font-weight:bold;" placeholder="0" readonly="readonly">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-md-5">
						<div class="form-group" id="">
							<label class="control-label col-md-4" for="aaa_kode"><strong>Volume :</strong></label>
							<div class="col-md-8">
					...
					<div class="form-group">
						...
						<div class="form-group" id="">
							...
							<?php $angka = $id="total_sum"; $desimal ="2"; $koma =","; $titik ="."; echo "Rp. ".number_format($angka, $desimal, $koma, $titik); ?>
							</div>
						</div>
						</div>
					</div>
