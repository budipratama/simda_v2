		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<form action="<?php echo site_url('rka/murni/edits/'.$kode);?>" class="form-horizontal" method="post" name="autoSumForm" onSubmit="return validasi()"><br>
					<input type="hidden" name="kode" value="<?php echo $kode; ?>"/>					
					<input type="hidden" name="id_kode" id="id_kode" value="<?php echo $rka; ?>" />
						...
						<div class="form-group" id="">
							...
							<div class="col-md-5">
							<input type="text" class="form-control" name="bbb_kode" maxlength="16" id="satuan" style="text-align:right;" value="<?php echo $harga; ?>" onkeypress="return isNumber(event)" onkeyup="totalSum()" placeholder="0" required="required">
							</div>
						</div>
						</div>
					</div>				
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
							<input type="text" class="form-control" name="firstBox" onFocus="startCalc();" onBlur="stopCalc();" maxlength="16" id="volume1" style="text-align:right;" value="<?php echo $volume; ?>" onkeypress="return isNumber(event)" onkeyup="totalSum()" placeholder="0" required="required">
							</div>
						</div>
						</div>						
						<div class="col-md-7">
						<div class="form-group">
							...
							<div class="col-md-4">
							<input type="input" class="form-control" maxlength="40" id="userInput1" value="<?php echo $satuan; ?>" onkeyup="showMsg()" placeholder="-">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group" id="">
							...
							<input type="text" class="form-control" name="thirdBox" id="thirdBox" style="text-align:right;font-weight:bold;" value="<?php echo $volume; ?>"  placeholder="0" readonly="readonly">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group" id="">
							...
							<div class="col-md-8">
							<input type="text" class="form-control" name="userMsg" id="userMsg" style="text-align:left;font-weight:bold;" value="<?php echo $satuan; ?>" placeholder="-" readonly="readonly">
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group" id="">
							...
							<div class="col-md-8">
							<input type="text" class="form-control" name="total_sum" id="total_sum" style="text-align:right;font-weight:bold;" value="<?php echo $total; ?>" placeholder="0" readonly="readonly">
							</div>
						</div>
						</div>
					</div>
							<div class="form-group">
								<div class="col-md-offset-9">
									...
									<a href="<?php echo base_url(); ?>rka/murni/sub/<?php echo $rka; ?>" class="btn btn-default"><i class="fa fa-times"></i> Batal</a>
								</div>
							</div>
							</div>
						</div>
