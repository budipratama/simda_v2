							...
							<ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">                                     
                                        <li><a title="Kembali" href="<?php echo base_url(); ?>rka/perubahan/sub/<?php echo $rincian; ?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">										
											<form action="<?php echo site_url('rka/perubahan/edits/'.$kode);?>" id="form_validation" class="form-horizontal" method="post" name="autoSumForm" onSubmit="return validasi()"><br>
														...
														<div class="row clearfix">
															...
															<div class="form-group">
																<div class="col-md-offset-9">
																	...
																	<a href="<?php echo base_url(); ?>rka/perubahan/sub/<?php echo $rincian; ?>" class="btn btn-default">Batal</a>
																</div>
															</div>
														</div>
													</div>
