...
class Pra_rencana_kerja extends CI_Controller {
	...
	public function index()
	{
		...
		if ($admin_log['level_kode'] == 5 || $admin_log['level_kode'] == 4){
			$skpd = $this->Skpd_model->get('skpd_kode, skpd_kd, skpd_nama', array('skpd_kd' => $admin_log['skpd_kd']));
			$container['content']['dataset']['skpd_kode']	= $admin_log['skpd_kd'];
			$container['content']['dataset']['skpd_nama']	= $admin_log['skpd_nama'];
		...
		$container['content']['dataset']['skpd']		= $this->Skpd_model->grid_all('skpd_kode, skpd_nama', 'skpd_nama', 'ASC', '', '', $where_skpd, array('skpd_tahun'=>$admin_log['tahun']));
		$where_kecamatan								= 'skpd_status IN (\'Kecamatan\')';
		$container['content']['dataset']['kecamatan']	= $this->Skpd_model->grid_all('skpd_kd, skpd_nama', 'skpd_nama', 'ASC', '', '', $where_kecamatan);
		$container['content']['dataset']['tahun_1']		= $admin_log['tahun'];
		$container['content']['dataset']['tahun_2']		= $admin_log['skpd_kd'];
