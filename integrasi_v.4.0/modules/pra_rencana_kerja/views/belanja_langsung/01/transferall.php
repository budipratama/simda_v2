...
<div class="container-fluid">
	<div class="side-body padding-top">
		<h3 class="page-title">Transfer Pra Rencana Kerja<small> anggaran belanja langsung</small></h3>
		<div class="row">
			<div class="col-xs-12">
				<div class="bs-example">
					<ol class="breadcrumb">
						...
						<li class="active"><a href="#"> Transfer Belanja Langsung</a></li>
					</ol>
				</div><br>
...
<!-- END PAGE HEADER-->
     ...
     <div class="panel panel-success">
						<div class="panel-heading"><i class="fa fa-pencil-square-o"></i> Transfer Pra Rencana Kerja</div>
					<div class="panel-body">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('pra-rencana-kerja/allTransfer/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="text" name="foto" id="foto" class="form-control" value="<?php echo $foto; ?>" readonly="readonly">
                                                </div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-12">
											...
											<div class="col-md-4">
												<div class="input-group">
													<input type="text" class="form-control" name="koordinat" id="koordinat"  value="<?php echo $koordinat; ?>" readonly="readonly">
													...
													<div class="col-md-6">
														<div class="row">
															<div class="col-md-offset-3 col-md-9">
																<button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Simpan & Transfer Data</button>
	...
	function show_form_kegiatan_by_program(){
		...
		load('pra-rencana-kerja/tampil_combobox_hasil_by_program/'+program_kode+'/'+skpd_kode, '#tampil_combobox_hasil_by_program');
		load('pra-rencana-kerja/tampil_kegiatan_lainnya/', '#tampil_combobox_kegiatan_lainnya');
	}
