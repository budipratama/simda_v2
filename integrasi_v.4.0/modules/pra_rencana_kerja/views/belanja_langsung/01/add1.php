            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<h2>Pra Rencana Kerja <small>Data Belanja Langsung</small></h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?php echo site_url('dashboard');?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
											...
											<div class="row clearfix">
												<div class="col-md-3">
													...
													<div class="form-group form-float">
														<div class="form-line">
														<input type="text" class="form-control" name="tahun" id="tahun" value="<?php echo $tahun_; ?>" readonly="readonly">
														</div>
													</div>
												</div>
												<div class="col-md-9">
	...
	<div id="tahunAnggaran" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="<?php echo site_url('pra-rencana-kerja/tahun');?>" class="form-horizontal" method="post">
				<div class="modal-body">
