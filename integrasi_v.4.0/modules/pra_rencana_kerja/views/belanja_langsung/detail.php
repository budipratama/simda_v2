                        ...
                        <div class="body">
							...
							<form action="<?php echo site_url('pra-rencana-kerja/insert/bl');?>" id="form_validation" enctype="multipart/form-data" method="POST">
								<div class="row clearfix">
									...
									<div class="col-md-9">
										...
										<div class="form-group form-float">
											<div class="form-line">
											<?php if ($skpd_aktive == 'yes') { combobox('db', $skpd, 'skpd_kode', 'skpd_kode', 'skpd_nama', $skpd_, 'show_form_misi_by_skpd();', 'Pilih SKPD Pelaksana', 'class="form-control show-tick" data-live-search="true" tabindex="1" readonly="readonly" disabled'); 
											} else { 
							...
							<h3 class="form-section"><b>Asumsi Biaya Pendanaan</b></h3>
								...
								<div class="btn-group" style="margin-left:100px;">
									<a href="<?php echo site_url('pra-rencana-kerja/transfer/'.$kode);?>" class="btn btn-info">Transfer ke Renja Murni Tahun <?php echo $tahun_sekarang;?></a>
								</div>
								<div class="btn-group" style="margin-left:50;">
									<a href="<?php echo site_url('pra-rencana-kerja/transfer-perubahan/'.$kode);?>" class="btn btn-success">Transfer ke Renja Perubahan Tahun <?php echo $tahun_sekarang;?></a>
									<!--<a href="<?php echo site_url('pra-rencana-kerja/transfer-perubahan/'.$kode);?>" class="btn btn-warning"><i class="fa fa-paper-plane"></i> Transfer ke Renja Perubahan Tahun <?php echo $tahun_anggaran;?></a>-->
								</div>
                            </form>
							</div>
							</div>
