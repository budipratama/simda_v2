<!-- Main Content -->   
   <section class="content">
		<h2>Rencana Kerja Murni<small> entri data &amp; informasi detail</small></h2>  
			<div class="body">
								...
								<div class="row clearfix">
										...
										<div class="portlet-body">
											...
											<tr>
												...
												<th>Nama Kegiatan</th>
												<th>Lokasi</th>
												<th style="width:71px;">Sumber</th>
												<th style="width:71px;">SKPD/Kecamatan</th>
												<th style="width:30px;">Transfer</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja Murni"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"Musrenbang Kabupaten"</strong></font>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja Murni"</strong></font> sudah ditransfer ke <font color="blue"><strong>"Musrenbang Kabupaten"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successDelete" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Hapus Pra Rencana Kerja Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja Murni"</strong></font> telah berhasil dihapus !</font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
