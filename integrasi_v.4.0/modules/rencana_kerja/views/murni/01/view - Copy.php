...
<div class="container-fluid">
	<div class="side-body padding-top">
		<h3 class="page-title">Hasil Rencana Kerja Murni <small>entri data &amp; informasi detail</small></h3>
		<div class="row">
            <div class="col-xs-12">
				<div class="bs-example">
					<ol class="breadcrumb">
						<li class="active"><i class="fa fa-home"></i> <a href="<?php echo site_url('dashboard');?>">Home</a></li>
						<li class="active"><a href="<?php echo site_url('rencana-kerja/murni');?>">Rencana Kerja</a></li>
						<li class="active">Murni</a></li>
					</ol>
				</div>
            </div>
        </div>
				...
				<div class="panel-body">
					...
					<div class="portlet panel-success">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-search"></i><small>Pencarian Hasil Rencana Kerja Murni</small></div>
							<div class="tools">
						...
						<!-- BEGIN FORM-->
							<form action="<?php echo site_url('rencana-kerja/murni/cari');?>" class="form-horizontal" method="post">
					...
					<div style="margin-left:500px;">
						<div class="col-md-12">
							<div class="col-md-offset-1 col-md-12">
								...
								<a href="<?php echo site_url('rencana-kerja/murni');?>" id="confirmasiHapus" class="btn btn-default"><i class="fa fa-eraser"></i> Clear</a>
							</div>
						</div>
					</div>
					<!--/row-->							
			...
			<div class="panel-heading"><i class="fa fa-list"></i> Daftar Hasil Rencana Kerja Murni</div>
			<div class="panel-body">
						<script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Success!</strong> Tambah Rencana Kerja Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja Murni"</strong></font> telah berhasil ditambahkan !
				</div>
	...
	<div id="successUpdate" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Success!</strong> Ubah Rencana Kerja Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> telah berhasil diperbaharui !
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successDelete" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Success!</strong> Hapus Rencana Kerja Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> telah berhasil dihapus !
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Success!</strong> Transfer Rencana Kerja Murni</h4>
				</div>
				<div class="modal-body">
					 Data Rencana Kerja telah berhasil ditransfer ke <font color="green"><strong>"Musrenbang Kabupaten!"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Transfer Rencana Kerja Murni</h4>
				</div>
				<div class="modal-body">
					 Data Rencana Kerja sudah ditransfer ke <font color="green"><strong>"Musrenbang Kabupaten!"</strong></font>
				</div>
				<div class="modal-footer">
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('rencana_kerja/murni/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>