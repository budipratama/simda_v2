...
<!-- END PAGE HEADER-->
			...
			<div class="panel panel-success">
					...
					<div class="panel-body">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('rencana-kerja/murni/update/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
	...
	function show_form_kegiatan_by_program(){
		...
		load('rencana-kerja/murni/tampil_combobox_hasil_by_program/'+program_kode, '#tampil_combobox_hasil_by_program');
