<!-- Main Content -->
            <div class="container-fluid">
				...
				<h3 class="page-title">Detail Hasil Pra Rencana Kerja <small>anggaran belanja langsung</small></h3>
								...
								<div style="margin-left:83px;">
									<div class="col-md-12">
										<div class="col-md-offset-1 col-md-12">
											...
											<a href="<?php echo site_url('rencana-kerja/murni/transfer/'.$kode);?>" class="btn btn-info"><i class="fa fa-paper-plane"></i> Transfer ke Musrenbang Kabupaten</a>
										</div>
