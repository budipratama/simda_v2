<!-- Main Content -->   
   <section class="content">
		<h2>Rencana Kerja <small> entri data &amp; informasi detail</small></h2>  
			<div class="body">
								...
								<div class="body">
									...
									<div class="portlet-body">
										...
										<tr>
											...
											<th style="width:50px;text-align:center;">Sumber</th>
											<th style="width:50px;text-align:center;">Transfer</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Success!</strong> Tambah Rencana Kerja</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> telah berhasil ditambahkan !
				</div>
	...
	<div id="successUpdate" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Success!</strong> Edit Rencana Kerja</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> telah berhasil diubah !
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Success!</strong> Transfer Rencana Kerja</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"Musrenbang Kabupaten"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Transfer Rencana Kerja</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> sudah ditransfer ke <font color="blue"><strong>"Musrenbang Kabupaten"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successDelete" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Hapus Rencana Kerja</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana Kerja"</strong></font> telah berhasil dihapus !</font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
