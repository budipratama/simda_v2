<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Hasil Rencana Kerja Perubahan <small>entri data &amp; informasi detail</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('rencana-kerja/perubahan');?>">Rencana Kerja</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo site_url('rencana-kerja/perubahan');?>">Perubahan</a>
					</li>
				</ul>
			</div>
            <!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-search"></i>Pencarian Hasil Rencana Kerja Perubahan
										</div>
										<div class="tools">
									...
									<div class="portlet-body form" style="<?php echo (isset($formCari)?'display:none;':'')?>">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('rencana-kerja/perubahan/cari');?>" class="form-horizontal" method="post">
											<div class="form-body">
													...
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-offset-1 col-md-12">
																<button type="submit" class="btn green"><i class="fa fa-check"></i>  Cari Hasil Rencana Kerja Perubahan</button>
																<a href="<?php echo site_url('rencana-kerja/perubahan');?>" class="btn default"> <i class="fa fa-times"></i> Bersihkan Hasil Pencarian</a>
																<!--
																<div class="btn-group" style="margin-left:100px;">
																	...
																	<li>
																		<a href="<?php echo site_url('rencana-kerja/perubahan/belanja-langsung');?>">Belanja Langsung</a>
																	</li>
																	<li>
																		<a href="<?php echo site_url('rencana-kerja/perubahan/belanja-tidak-langsung');?>">Belanja Tidak Langsung</a>
																	</li>
																	</ul>
																</div>
																-->
            ...
            <div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>Daftar Hasil Rencana Kerja Perubahan
							</div>
						</div>
						<script>
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('rencana_kerja/perubahan/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>