								...
								<div style="margin-left:83px;">
									<div class="col-md-12">
										...
										<div class="btn-group" style="margin-left:100px;">
											<a href="<?php echo site_url('rencana-kerja/perubahan/transfer/'.$kode);?>" class="btn btn-info"><i class="fa fa-paper-plane"></i> Transfer ke RKPD Perubahan <?php echo $tahun;?></a>
										</div>
										</div>
