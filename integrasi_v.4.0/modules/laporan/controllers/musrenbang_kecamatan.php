...
class Musrenbang_kecamatan extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/musrenbang_kecamatan/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/musrenbang_kecamatan/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/musrenbang-kecamatan/preview', 'refresh');
		}
	...
	{	
		...
		$this->load->view('laporan/musrenbang_kecamatan/hasil', $laporan);
	}
