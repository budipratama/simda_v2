...
class Musrenbang_kelurahan extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/musrenbang_kelurahan/view';
		...
		$where_skpd										= 'skpd_status IN (\'SKPD\')';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/musrenbang_kelurahan/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/musrenbang-kelurahan/preview', 'refresh');
		}
	...
	{	
		...
		if ($laporan['laporan_skpd'] != 'semua'){
			...
			$laporan['skpd_nama']		= 'SELURUH KELURAHAN';
