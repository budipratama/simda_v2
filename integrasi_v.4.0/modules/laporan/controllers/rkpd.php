...
class Rkpd extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/rkpd/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/rkpd/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/rkpd/preview', 'refresh');
		}
	...
	{	
		...
		if ($laporan['laporan_jenis'] == '1'){
			$this->load->view('laporan/rkpd/hasil', $laporan);
		} else {
			$this->load->view('laporan/rkpd/hasil_perubahan', $laporan);
		}
	}
