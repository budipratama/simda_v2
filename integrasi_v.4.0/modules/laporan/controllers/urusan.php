...
class Urusan extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/urusan/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/urusan/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/urusan/preview', 'refresh');
		}
	...
	{	
		...
		$this->load->view('laporan/urusan/hasil', $laporan);
	}
}
