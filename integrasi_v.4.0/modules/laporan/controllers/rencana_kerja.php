...
class Rencana_kerja extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/rencana_kerja/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/rencana_kerja/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/rencana-kerja/preview', 'refresh');
		}
	...
	{	
		...
		if ($laporan['laporan_jenis'] == '1'){
			$this->load->view('laporan/rencana_kerja/hasil', $laporan);
		} else {
