...
class Kua_ppas extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/kua_ppas/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/kua_ppas/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/kua-ppas/preview', 'refresh');
		}
	...
	{	
		...
		if ($laporan['laporan_jenis'] == '1'){
			$this->load->view('laporan/kua_ppas/hasil', $laporan);
		} else {
			$this->load->view('laporan/kua_ppas/hasil_perubahan', $laporan);
		}
	} 
