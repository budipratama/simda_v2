...
class Musrenbang_desa extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/musrenbang_desa/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/musrenbang_desa/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/musrenbang-desa/preview', 'refresh');
		}
	...
	{	
		...
		if ($laporan['laporan_skpd'] != 'semua'){
			...
			$laporan['skpd_nama']		= 'SELURUH DESA';
