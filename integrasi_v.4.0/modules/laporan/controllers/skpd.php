...
class Skpd extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/skpd/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/skpd/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/skpd/preview', 'refresh');
		}
	...
	{	
		...
		$this->load->view('laporan/skpd/hasil', $laporan);
	}
}
