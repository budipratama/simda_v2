...
class Dpa extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model('Anggaran_kas_model');
	...
	public function index() {	
		...
		$container['content']['view']					= 'laporan/dpa/view';
	...
	public function v_22() {	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/dpa/view_22';
	...
	public function preview_22() {	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/dpa/preview_22';
		...
		if ($this->input->post('tahun_kode')) { 
			...
			redirect('laporan/dpa/preview_22', 'refresh');
		}
	...
	public function h_22() {	
		...
		if ($laporan['laporan_belanja'] == '1'){
			$this->load->view('laporan/dpa/hasil_22', $laporan);
		} else {
			$this->load->view('laporan/dpa/hasil_22_', $laporan);
		}
	} 
	...
	public function v_221() {	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/dpa/view_221';
	...
	public function preview_221() {	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/dpa/preview_221';
		...
		if ($this->input->post('tahun_kode')) { 
			$this->session->unset_userdata('is_sess_laporan');
			$this->session->set_userdata('is_sess_laporan', $sess_laporan);
			redirect('laporan/dpa/preview_221', 'refresh');
		}
	...
	public function h_221() {	
		...
		if ($laporan['laporan_belanja'] == '1'){
			$this->load->view('laporan/dpa/hasil_221', $laporan);
		} else {
			$this->load->view('laporan/dpa/hasil_221_', $laporan);
		}
	} 
