...
class Musrenbang_kabupaten extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/musrenbang_kabupaten/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/musrenbang_kabupaten/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/musrenbang-kabupaten/preview', 'refresh');
		}
	...
	{	
		...
		$this->load->view('laporan/musrenbang_kabupaten/hasil', $laporan);
	}
