...
class Rka extends CI_Controller {
	...
	public function preview() {	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/rka/preview';
		...
		$sess_laporan = array(
			...
			'laporan_jenis'  	=> $this->input->post('belanja_kode'),
		...
		if ($this->input->post('tahun_kode')) { 
			...
			redirect('laporan/rka/preview', 'refresh');
		}
	...
	public function tampil_combobox_program_by_tahun(){
		...
		if (!empty($kode_tahapan == 16)){
			combobox('db', $data_bl, 'program_kode', 'kode', 'program', '', 'show_form_kegiatan_by_program();', 'Semua Program', 'class="select2_category form-control" tabindex="1" required="required"');		
		} else {
			combobox('db', $data_btl, 'program_kode', 'kode', 'program', '', 'show_form_kegiatan_by_program();', 'Semua Program', 'class="select2_category form-control" tabindex="1" required="required"');		
		}
	}
	...
	public function tampil_combobox_kegiatan_by_program(){
		...
		if (!empty($kode_tahapan == 16)){
			combobox('db', $data_bl, 'kegiatan_kode', 'kode', 'kegiatan', '', '', 'Semua Kegiatan', 'class="select2_category form-control" tabindex="1" required="required"');		
		} else {
			combobox('db', $data_btl, 'kegiatan_kode', 'kode', 'kegiatan', '', '', 'Semua Kegiatan', 'class="select2_category form-control" tabindex="1" required="required"');		
		}
	}
