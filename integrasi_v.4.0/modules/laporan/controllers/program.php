...
class Program extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/program/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/program/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/program/preview', 'refresh');
		}
	...
	{	
		...
		$this->load->view('laporan/program/hasil', $laporan);
	}
}
