...
class Indikator_belum_terpakai extends CI_Controller {
	...
	{	
		...
		$container['content']['view']					= 'laporan/indikator_belum_terpakai/view';
	...
	{	
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 19;
		$container['content']['view']					= 'laporan/indikator_belum_terpakai/preview';
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('laporan/indikator-belum-terpakai/preview', 'refresh');
		}
	...
	{	
		...
		$this->load->view('laporan/indikator_belum_terpakai/hasil', $laporan);
	}
}
