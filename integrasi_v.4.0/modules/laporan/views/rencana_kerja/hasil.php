...
header("Content-Disposition: attachment;Filename=Laporan_Rencana_Kerja_".date("d_m_Y_H_i_s").".xls");
}
?>
<html>
<head>
...
<tr>
	<td colspan="3">
	<h2>DAFTAR RENCANA PROGRAM DAN KEGIATAN PRIORITAS TAHUN <?php echo $laporan_tahun;?></h2>
