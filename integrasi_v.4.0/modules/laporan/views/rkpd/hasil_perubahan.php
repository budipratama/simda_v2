...
header("Content-Disposition: attachment;Filename=Laporan_RKPD_Perubahan_".date("d_m_Y_H_i_s").".xls");
}
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=Windows-1252">
<title>LAPORAN RKPD PERUBAHAN KABUPATEN BEKASI</title>
<style>
@page {
	margin:0px;
	width:330mm;
...
<tr>
	<td colspan="3">
	<h2>DAFTAR RKPD PROGRAM DAN KEGIATAN PRIORITAS PERUBAHAN TAHUN <?php echo $laporan_tahun;?></h2>
