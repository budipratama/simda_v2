...
header("Content-Disposition: attachment;Filename=Laporan_Pra_Rencana_Kerja_".date("d_m_Y_H_i_s").".xls");
}
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=Windows-1252">
<title>LAPORAN PRA RENCANA KERJA</title>
<style>
@page {
	margin:0px;
	width:330mm;
...
<tr>
	<td colspan="3">
	<h2>DAFTAR PRA RENCANA PROGRAM DAN KEGIATAN PRIORITAS TAHUN <?php echo $laporan_tahun;?></h2>
...
if ($jumlah_data > 0){
	...
	for ($i=1; $i <= 2; $i++){
		...
		<tr style="font-weight:bold; background:#9F0;">
			...
			<td colspan="22">URUSAN <?php echo strtoupper($jenis_urusan[$i]);?></td>
		</tr>
			<?php
			...
			foreach ($this->Anggaran_model->grid_all('1', 'urusan.kode as urusan_kode, urusan.nomor as urusan_nomor, urusan.urusan as urusan_nama', 'urusan.nomor', 'ASC', '', '', $where_jenis, '', 'anggaran_bl.urusan_kode') as $row){
				...
				if ($this->Anggaran_model->count_bl($where_urusan) > 0){
					...
					<tr style="font-weight:bold;font-style:italic;">
						...
						<td colspan="22"><?php echo $row->urusan_nama;?></td>
					</tr>
					<?php
				}
				...
				<tr style="font-weight:bold; background:#FF0;">
            		...
            		<td colspan="22" style="padding-left:10px;"><?php echo $subrow->skpd_nama;?></td>
        		</tr>
					<?php
