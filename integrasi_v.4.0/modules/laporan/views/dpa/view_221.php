                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						<div class="header bg-pink">
                            <h2>Cetak Laporan DPA SKPD 2.2.1<small> Rincian Anggaran Belanja Langsung</small></h2>
						...
						<div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation"><a href="<?php echo site_url('laporan/dpa');?>">DPA SKPD 1</a></li>
                                <li role="presentation"><a href="<?php echo site_url('laporan/dpa/v_22');?>">DPA SKPD 2.2</a></li>
                                <li role="presentation" class="active"><a href="#221" data-toggle="tab">DPA SKPD 2.2.1</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
							<div class="body">
                                <div role="tabpanel" class="tab-pane fade in active" id="221">
                                    <b></b>
                                    <p><form action="<?php echo site_url('laporan/dpa/preview_221');?>" id="form_validation" enctype="multipart/form-data" method="POST">
										<div class="row clearfix">																			
											<div class="col-md-12">
										...
										<div class="form-group">
											<div class="col-md-offset-9">
												...
												<a href="<?php echo site_url('laporan/dpa/v_221');?>" class="btn default">Kembali</a>
											</div>
										</div>
                                    </form></p>
                                </div>
...
<script>
	function show_form_tahapan_by_skpd(){
		...
		load('laporan/dpa/tampil_combobox_tahapan_by_skpd/'+skpd_kode, '#tampil_combobox_tahapan_by_skpd');
		load('laporan/dpa/tampil_combobox_belanja_by_tahapan/', '#tampil_combobox_belanja_by_tahapan');
		load('laporan/dpa/tampil_combobox_tahun_by_belanja/', '#tampil_combobox_tahun_by_belanja');
		load('laporan/dpa/tampil_combobox_program_by_tahun/', '#tampil_combobox_program_by_tahun');
		load('laporan/dpa/tampil_combobox_kegiatan_by_program/', '#tampil_combobox_kegiatan_by_program');
	}
	
	function show_form_belanja_by_tahapan(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var kode_tahapan = $('select[name=kode_tahapan]').val();
		load('laporan/dpa/tampil_combobox_belanja_by_tahapan/'+skpd_kode+'/'+kode_tahapan, '#tampil_combobox_belanja_by_tahapan');
		load('laporan/dpa/tampil_combobox_tahun_by_belanja/', '#tampil_combobox_tahun_by_belanja');
		load('laporan/dpa/tampil_combobox_program_by_tahun/', '#tampil_combobox_program_by_tahun');
		load('laporan/dpa/tampil_combobox_kegiatan_by_program/', '#tampil_combobox_kegiatan_by_program');
	}
	...
	function show_form_tahun_by_belanja(){
		...
		var kode_tahapan = $('select[name=kode_tahapan]').val();
		load('laporan/dpa/tampil_combobox_tahun_by_belanja/'+skpd_kode+'/'+belanja_kode+'/'+kode_tahapan, '#tampil_combobox_tahun_by_belanja');		
		load('laporan/dpa/tampil_combobox_program_by_tahun/', '#tampil_combobox_program_by_tahun');
		load('laporan/dpa/tampil_combobox_kegiatan_by_program/', '#tampil_combobox_kegiatan_by_program');
	}
	...
	function show_form_program_by_tahun(){
		...
		var belanja_kode = $('select[name=belanja_kode]').val();
		var kode_tahapan = $('select[name=kode_tahapan]').val();
		load('laporan/dpa/tampil_combobox_program_by_tahun/'+skpd_kode+'/'+tahun_kode+'/'+belanja_kode+'/'+kode_tahapan, '#tampil_combobox_program_by_tahun');
		load('laporan/dpa/tampil_combobox_kegiatan_by_program/', '#tampil_combobox_kegiatan_by_program');
	}
	...
	function show_form_kegiatan_by_program(){
		...
		var belanja_kode = $('select[name=belanja_kode]').val();
		var kode_tahapan = $('select[name=kode_tahapan]').val();
		load('laporan/dpa/tampil_combobox_kegiatan_by_program/'+skpd_kode+'/'+program_kode+'/'+tahun_kode+'/'+belanja_kode+'/'+kode_tahapan, '#tampil_combobox_kegiatan_by_program');
	}
</script>