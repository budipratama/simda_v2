                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						<div class="header bg-pink">
                            <h2>Cetak Laporan  DPA SKPD 2.2<small>Rekapitulasi Anggaran Belanja Langsung</small></h2>
						...
						<div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                ...
                                <li role="presentation" class="active"><a href="#22" data-toggle="tab">DPA SKPD 2.2</a></li>
                            ...
                            <div class="body">
                                <div role="tabpanel" class="tab-pane fade in active" id="22">
                                    <b></b>
                                    <p><form action="<?php echo site_url('laporan/dpa/preview_22');?>" id="form_validation" enctype="multipart/form-data" method="POST">
										<div class="row clearfix">																			
											<div class="col-md-12">
