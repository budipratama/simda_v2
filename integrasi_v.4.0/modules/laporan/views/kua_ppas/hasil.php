...
header("Content-Disposition: attachment;Filename=Laporan_KUA_PPAS_".date("d_m_Y_H_i_s").".xls");
}
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=Windows-1252">
<title>LAPORAN KUA & PPAS</title>
<style>
@page {
	margin:0px;
	width:330mm;
...
<tr>
	<td colspan="3">
	<h2>DAFTAR KUA & PPAS PROGRAM DAN KEGIATAN PRIORITAS TAHUN <?php echo $laporan_tahun;?></h2>
