<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Pra APBD Kabupaten <small>cetak laporan</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bookmark"></i>Cetak Laporan Pra APBD Kabupaten
							</div>
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo site_url('laporan/pra-apbd/preview');?>" class="horizontal-form" method="post">
								<div class="form-body">
									<div class="row">
										<div class="col-md-3">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="radio" name="jenis_anggaran" id="jenis_anggaran" value="1" checked> Murni </label>
												<label class="radio-inline">
												<input type="radio" name="jenis_anggaran" id="jenis_anggaran" value="2"> Perubahan </label>
											</div>
										</div>
										<div class="col-md-5">
											<div class="form-group">
										...
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label">Jenis Laporan :</label><br>
												<label class="radio-inline">
												<input type="radio" name="jenis_laporan" id="jenis_anggaran" value="1" checked> Laporan Final </label>
												<label class="radio-inline">
												<input type="radio" name="jenis_laporan" id="jenis_anggaran" value="2"> Laporan Parsial </label>
											</div>
										</div>
										<!--/span-->
									</div>
										...
										<div class="col-md-9">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<button type="submit" name="cetak" class="btn green"><i class="fa fa-check"></i> Lihat Laporan Pra APBD Kabupaten</button>
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('laporan/pra-apbd/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>