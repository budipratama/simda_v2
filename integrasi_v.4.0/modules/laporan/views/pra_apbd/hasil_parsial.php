...
header("Content-Disposition: attachment;Filename=Laporan_Pra_APBD_Parsial_".date("d_m_Y_H_i_s").".xls");
}
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=Windows-1252">
<title>LAPORAN PRA APBD KABUPATEN PARSIAL</title>
<style>
@page {
	margin:0px;
	width:330mm;
...
<tr>
	<td colspan="3">
	<h2>DAFTAR PRA APBD KABUPATEN PARSIAL PROGRAM DAN KEGIATAN PRIORITAS TAHUN <?php echo $laporan_tahun;?></h2>
...
<tr>
    ...
    <tr style="border-bottom:#999 solid 2px;">
		...
		<th rowspan="3" width="80">Kecamatan</th>
		<th rowspan="3" width="80">Desa/Kelurahan</th>
...
if ($jumlah_data > 0){
	...
	for ($i=1; $i <= 2; $i++){
		...
		$where_jenis['anggaran.perubahan_status_kode !='] 	= '1';
		...
		<tr style="font-weight:bold; background:#9F0;">
			...
			<td colspan="26">URUSAN <?php echo strtoupper($jenis_urusan[$i]);?></td>
		</tr>
			<?php
			...
			foreach ($this->Anggaran_model->grid_all('1', 'urusan.kode as urusan_kode, urusan.nomor as urusan_nomor, urusan.urusan as urusan_nama', 'urusan.nomor', 'ASC', '', '', $where_jenis, '', 'anggaran_bl.urusan_kode') as $row){
				...
				$where_urusan['anggaran.perubahan_status_kode !='] 	= '1';
				...
				if ($this->Anggaran_model->count_bl($where_urusan) > 0){
					...
					<tr style="font-weight:bold;font-style:italic;">
						...
						<td colspan="26"><?php echo $row->urusan_nama;?></td>
					</tr>
					<?php
				}
				...
				<tr style="font-weight:bold; background:#FF0;">
            		...
            		<td colspan="26" style="padding-left:10px;"><?php echo $subrow->skpd_nama;?></td>
        		</tr>
					<?php
					...
					if ($this->Skpd_model->count_all(array('skpd_kode'=>$subrow->skpd_kode, 'urusan'=>$row->urusan_kode)) == 1){
						...
						$where_skpd_rutin['anggaran.perubahan_status_kode !='] = '1';
						...
						foreach ($this->Anggaran_model->grid_all('1', 'SUM(anggaran_bl.apbd_kab) as subjumlah_apbdkab, SUM(anggaran_bl.apbd_prov) as subjumlah_apbdprov, SUM(anggaran_bl.apbn) as subjumlah_apbn, SUM(anggaran_bl.sumberlain) as subjumlah_lainnya, SUM(anggaran_bl.apbd_kab+anggaran_bl.apbd_prov+anggaran_bl.apbn+anggaran_bl.sumberlain) as subjumlah_total, SUM(anggaran_bl.perkiraan_maju) as subjumlah_maju, program.kode as program_kode, program.nomor as program_nomor, program.program as program_nama', 'program.nomor', 'ASC', '', '', $where_skpd_rutin, '', 'program.kode') as $subsubrow){
							...
							$where_program_rutin['anggaran.perubahan_status_kode !='] = '1';
							...
							<tr style="font-weight:bold; font-style:italic;">
								...
								<td colspan="17" style="padding-left:20px;"><?php echo $subsubrow->program_nama;?></td>
							...
							foreach ($this->Anggaran_model->grid_all('1', 'anggaran.kegiatan, anggaran.alamat, anggaran_bl.hp_ukur, anggaran_bl.hp_target, anggaran_bl.hp_satuan, anggaran_bl.kh_ukur, anggaran_bl.kh_target, anggaran_bl.kh_satuan, deskel.skpd_nama as deskel_nama, kecamatan.skpd_nama as kecamatan_nama, anggaran_bl.hk_ukur, anggaran_bl.hk_target, anggaran_bl.hk_satuan, anggaran_bl.apbd_kab, anggaran_bl.apbd_prov, anggaran_bl.apbn, anggaran_bl.sumberlain, anggaran_bl.perkiraan_maju, sifat.sifat_nama, sumber.sumber_nama, (anggaran_bl.apbd_kab+anggaran_bl.apbd_prov+anggaran_bl.apbn+anggaran_bl.sumberlain) as rencana_total, skpd.skpd_nama as skpd_nama, urusan.urusan as urusan_nama, sasaran.sasaran as sasaran_nama, prioritas.prioritas as prioritas_nama, program.program as program_nama, indikator.indikator as indikator_nama, perubahan_status.perubahan_status_nama as perubahan_nama', 'anggaran.kegiatan', 'ASC', '', '', $where_program_rutin, '', 'anggaran.kode') as $kegiatanrow){
							...
							<tr>
                                ...
                                <td><?php echo $kegiatanrow->perubahan_nama;?></td>
							</tr>
					...
					$where_skpd['anggaran.perubahan_status_kode !='] 			= '1';
					...
					foreach ($this->Anggaran_model->grid_all('1', 'SUM(anggaran_bl.apbd_kab) as subjumlah_apbdkab, SUM(anggaran_bl.apbd_prov) as subjumlah_apbdprov, SUM(anggaran_bl.apbn) as subjumlah_apbn, SUM(anggaran_bl.sumberlain) as subjumlah_lainnya, SUM(anggaran_bl.apbd_kab+anggaran_bl.apbd_prov+anggaran_bl.apbn+anggaran_bl.sumberlain) as subjumlah_total, SUM(anggaran_bl.perkiraan_maju) as subjumlah_maju, program.kode as program_kode, program.nomor as program_nomor, program.program as program_nama', 'program.nomor', 'ASC', '', '', $where_skpd, '', 'anggaran_bl.program_kode') as $subsubrow){
						...
						$where_program['anggaran.perubahan_status_kode !='] = '1';
						...
						foreach ($this->Anggaran_model->grid_all('1', 'anggaran.kegiatan, anggaran.alamat, anggaran_bl.hp_ukur, anggaran_bl.hp_target, anggaran_bl.hp_satuan, anggaran_bl.kh_ukur, anggaran_bl.kh_target, anggaran_bl.kh_satuan, anggaran_bl.hk_ukur, anggaran_bl.hk_target, anggaran_bl.hk_satuan, anggaran_bl.apbd_kab, anggaran_bl.apbd_prov, anggaran_bl.apbn, anggaran_bl.sumberlain, anggaran_bl.perkiraan_maju, sifat.sifat_nama, deskel.skpd_nama as deskel_nama, kecamatan.skpd_nama as kecamatan_nama, sumber.sumber_nama, (anggaran_bl.apbd_kab+anggaran_bl.apbd_prov+anggaran_bl.apbn+anggaran_bl.sumberlain) as rencana_total, skpd.skpd_nama as skpd_nama, urusan.urusan as urusan_nama, sasaran.sasaran as sasaran_nama, prioritas.prioritas as prioritas_nama, program.program as program_nama, indikator.indikator as indikator_nama, perubahan_status.perubahan_status_nama as perubahan_nama', 'anggaran.kegiatan', 'ASC', '', '', $where_program, '', 'anggaran.kode') as $kegiatanrow){
						if ($kegiatan_nomor < 10) {
							$kegiatan_nomor = "0".$kegiatan_nomor;
						} else {
							$kegiatan_nomor = $kegiatan_nomor;
...
?>
	<tr style="font-weight:bold; background:#9F0;">
		<td colspan="26" align="center">Belum ada data.</td>
	</tr>
<?php
}
?>
	<tr style="font-weight:bold;font-size:14px;">
    	<th colspan="18" align="center">TOTAL</th>
