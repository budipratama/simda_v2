                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						<div class="header bg-pink">
                            <h2>Cetak Laporan RKA SKPD 2.2.1<small> Rincian Anggaran Belanja Langsung</small></h2>
						...
						<div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                ...
                                <li role="presentation" class="active"><a href="#221" data-toggle="tab">RKA SKPD 2.2.1</a></li>
                            </ul>
                            <!-- Tab panes -->
							...
							<div class="body">
                                <div role="tabpanel" class="tab-pane fade in active" id="221">
                                    <b></b>
                                    <p><form action="<?php echo site_url('laporan/rka/preview_221');?>" id="form_validation" enctype="multipart/form-data" method="POST">
										<div class="row clearfix">																			
											<div class="col-md-12">
										...
										<div class="form-group">
											<div class="col-md-offset-9">
												...
												<a href="<?php echo site_url('laporan/rka/v_221');?>" class="btn default">Kembali</a>
											</div>
										</div>
                                    </form></p>
                                </div>
