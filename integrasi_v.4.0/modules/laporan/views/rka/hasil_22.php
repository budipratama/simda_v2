				...
				$strhtml .= "
					...
					if ($this->Skpd_model->count_all(array('skpd_kode'=>$subrow->skpd_kode))){						
						...
						foreach ($this->Rka_model->grid_all('1', 'anggaran.kode as id_kode, anggaran.kegiatan, anggaran.alamat, anggaran_bl.kh_target as kht_anggaran, anggaran_bl.kh_satuan as khs_anggaran', 'anggaran.kegiatan', 'ASC', '', '', $where_program_rutin, '', 'rka.anggaran_kode') as $kegiatanrow){
							...
							$tampil1 = mysql_query("SELECT SUM(rka_sub.total) as totalRKA1 FROM rka_sub INNER JOIN rka ON rka_sub.rka=rka.kode INNER JOIN skpd ON rka.skpd=skpd.skpd_kode WHERE rka.tahun='".$laporan_tahun."' AND rka.tipe_kode='".$laporan_belanja."' AND rka.skpd='".$laporan_skpd."' AND rka.anggaran_kode='".$kegiatanrow->id_kode."' AND rka.jenis='63' ORDER BY rka_sub.kode ASC"); 	
							$tampil2 = mysql_query("SELECT SUM(rka_sub.total) as totalRKA2 FROM rka_sub	INNER JOIN rka ON rka_sub.rka=rka.kode INNER JOIN skpd ON rka.skpd=skpd.skpd_kode WHERE rka.tahun='".$laporan_tahun."' AND rka.tipe_kode='".$laporan_belanja."' AND rka.skpd='".$laporan_skpd."' AND rka.anggaran_kode='".$kegiatanrow->id_kode."' AND rka.jenis='64' ORDER BY rka_sub.kode ASC"); 	
							$tampil3 = mysql_query("SELECT SUM(rka_sub.total) as totalRKA3 FROM rka_sub INNER JOIN rka ON rka_sub.rka=rka.kode INNER JOIN skpd ON rka.skpd=skpd.skpd_kode WHERE rka.tahun='".$laporan_tahun."' AND rka.tipe_kode='".$laporan_belanja."' AND rka.skpd='".$laporan_skpd."' AND rka.anggaran_kode='".$kegiatanrow->id_kode."' AND rka.jenis='65' ORDER BY rka_sub.kode ASC"); 
							...
							$tampil_sub1 = mysql_query("SELECT SUM(rka_sub.total) as totalRKA1 FROM rka_sub INNER JOIN rka ON rka_sub.rka=rka.kode INNER JOIN skpd ON rka.skpd=skpd.skpd_kode WHERE rka.tahun='".$laporan_tahun."' AND rka.tipe_kode='".$laporan_belanja."' AND rka.skpd='".$laporan_skpd."' AND rka.jenis='63' ORDER BY rka_sub.kode ASC");
							$tampil_sub2 = mysql_query("SELECT SUM(rka_sub.total) as totalRKA2 FROM rka_sub INNER JOIN rka ON rka_sub.rka=rka.kode INNER JOIN skpd ON rka.skpd=skpd.skpd_kode WHERE rka.tahun='".$laporan_tahun."' AND rka.tipe_kode='".$laporan_belanja."' AND rka.skpd='".$laporan_skpd."' AND rka.jenis='64' ORDER BY rka_sub.kode ASC"); 
							$tampil_sub3 = mysql_query("SELECT SUM(rka_sub.total) as totalRKA3 FROM rka_sub INNER JOIN rka ON rka_sub.rka=rka.kode INNER JOIN skpd ON rka.skpd=skpd.skpd_kode WHERE rka.tahun='".$laporan_tahun."' AND rka.tipe_kode='".$laporan_belanja."' AND rka.skpd='".$laporan_skpd."' AND rka.jenis='65' ORDER BY rka_sub.kode ASC"); 
