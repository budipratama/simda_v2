...
header("Content-Disposition: attachment;Filename=Laporan_RKPD_".date("d_m_Y_H_i_s").".xls");
}
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=Windows-1252">
<title>LAPORAN RKPD KABUPATEN BEKASI</title>
<style>
@page {
	margin:0px;
	width:330mm;
...
<tr>
	<td colspan="3">
	<h2>DAFTAR RKPD PROGRAM DAN KEGIATAN PRIORITAS TAHUN <?php echo $laporan_tahun;?></h2>
