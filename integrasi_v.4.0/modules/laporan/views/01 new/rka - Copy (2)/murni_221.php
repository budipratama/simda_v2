...
$query_jumlah = mysql_query("SELECT SUM(total) 
	...
	while($row_belanja=mysql_fetch_array($query_belanja)){
		...
		$where_obyek['rka.tahun'] 				= $laporan_tahun;
		$where_obyek['rka.jenis']				= $jenis_belanja[$i]; 
		if ($laporan_skpd != 'semua'){ $where_obyek['skpd.skpd_kode'] 	= $laporan_skpd; }
		
		foreach ($this->Rup_model->grid_all('1', 'rka.skpd, rka.program, obyek.obyek_nama as nama_obyek', 'rka.no', 'ASC', '', '', $where_obyek, '', 'rka.kode') as $subsubrow){
			$strhtml .= "<table style='font-family: serif; border:1px solid #000;'>
			<tr>
				<th style='text-align:left; font-size:12pt; font-style:italic; font-weight:0; border:1px solid #000; width:150px'>1a = $laporan_skpd</th>
				<th style='text-align:left; font-size:12pt; font-style:italic; font-weight:0; border:1px solid #000; width:500px'>$subsubrow->nama_obyek</th>";
			...
			$strhtml .= "<th style='text-align:right; font-size:12pt; font-style:italic; font-weight:0; border:1px solid #000; width:600px'>1c</th>
			</tr>
			</table>";
			...
			$strhtml .= "<table style='font-family: serif; border:1px solid #000;'>
			<tr>
				<th style='text-align:left; font-size:12pt; font-weight:0; border:1px solid #000; width:150px'>2a</th>
				<th style='text-align:left; font-size:12pt; font-weight:0; border:1px solid #000; width:500px'>2b</th>";
			...
			$strhtml .= "<th style='text-align:right; font-size:12pt; font-weight:0; border:1px solid #000; width:600px'>3c</th>
			</tr>
			</table>";
