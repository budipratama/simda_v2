                                    ...
                                    <p><form action="<?php echo site_url('laporan/rka/preview2/'.$kode);?>" id="form_validation" enctype="multipart/form-data" class="horizontal-form" method="post">
										...
										<div class="row">
											...
											<label class="form-label" for="skpd">SKPD/Kecamatan :</label>
												<div class="form-group form-float">
													<div class="form-line">
													<?php if ($skpd_aktive == 'yes') { combobox('db', $skpd, 'aaa_kode', 'skpd_kode', 'skpd_nama', '', 'show_form_program_by_skpd();', 'Semua SKPD/Kecamatan', 'class="form-control show-tick" data-live-search="true" tabindex="1"');
													} else { 
											...
											<div class="row clearfix">
												<div class="col-md-6">
													...
													<div class="form-group form-float">
														<div class="form-line">										
														<?php combobox('db', $akun, 'aaaa_kode', 'kode', 'akun_nama', '', 'show_form_program_by_skpd();', 'Pilih Akun', 'class="form-control show-tick" data-live-search="true" tabindex="1" required="required"'); ?>														
														</div>								
													</div>								
												</div>
											</div>
