...
<a href="#warningHapus" data-toggle="modal"></a>
	...
	<div class="modal fade" id="addJenis" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-body form">
				<form action="<?php echo site_url('parameter/rekening/addj');?>" id="form" class="form-horizontal" method="POST">
	...
	<div class="modal fade" id="editJenis" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-body form">
				<form action="<?php echo site_url('parameter/rekening/editj');?>" id="form1" class="form-horizontal" method="post">
  ...
  <!-- End Bootstrap modal -->
    ...
    function add_jenis() {
		...
		$('.modal-title').text('Tambah Rekening Jenis'); // Set title to Bootstrap modal title
