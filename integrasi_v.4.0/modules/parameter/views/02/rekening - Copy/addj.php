                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?php echo site_url('parameter/rekening/jenis/'.$kelompok->kode);?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<form action="<?php echo site_url('parameter/rekening/addj/'.$kode->id);?>" class="form-horizontal" method="post" name="form" onSubmit="return validasi()">
										...
										<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
											...
											<div class="form-group">
												<div class="col-md-offset-9">
													...
													<a href="<?php echo site_url('parameter/rekening/jenis/'.$kelompok->kode);?>" class="btn btn-default">Batal</a>
												</div>
											</div>
											</div>
										</div>
