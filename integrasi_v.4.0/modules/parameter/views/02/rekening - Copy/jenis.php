                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
										<li><a title="Tambah" href="#" data-toggle="modal" data-target="#addJenis"><i class="material-icons">add_circle</i> Tambah Jenis</a></li>										
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tbody><?php if($jenis):?><?php foreach($jenis as $task):?>
												...
												<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo site_url('parameter/rekening/editj/'.$task->list_id);?>"><i class="fa fa-pencil"></i></a>
												<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" href="<?php echo site_url('parameter/rekening/delete/'.$task->list_id);?>"><i class="fa fa-trash-o"></i></a>
												</td>
												</tr>
												<?php endforeach; ?></ul>
									...
									<div class="row clearfix">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<div class="col-md-5">
												...
												<select name="eee_kode" class="form-control show-tick" data-live-search="true" tabindex="1" required="required">
