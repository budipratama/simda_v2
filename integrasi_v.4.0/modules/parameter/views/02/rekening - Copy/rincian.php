                                        ...
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tbody><?php if($rincian) : ?><?php foreach($rincian as $task) : ?>
												<tr>
													...
													<a class="btn btn-sm btn-warning" title="Ubah" href="#" value="<?php echo site_url('#editRincian/'.$task->list_id);?>" data-toggle="modal" data-target="#editRincian"><i class="fa fa-pencil"></i></a>
													
													
												<!--<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo site_url('parameter/rekening/editr/'.$task->list_id);?>"><i class="fa fa-pencil"></i></a>-->
													<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" href="<?php echo site_url('parameter/rekening/deleter/'.$task->list_id);?>"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
											<?php endforeach; ?></ul>
...
<a href="#warningHapus1" data-toggle="modal"></a>
	<div id="warningHapus1" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
	...
	<a href="#editRincian" data-toggle="modal"></a>
	<div id="editRincian" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
