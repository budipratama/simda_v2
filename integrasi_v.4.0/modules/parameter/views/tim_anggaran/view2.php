		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<table id="example1" class="table table-striped table-bordered table-hover">
					<thead><tr>
					<th style="text-align:center; width:50px">Nomor</th>
					...
					<th style="text-align:center;">Nama Organisasi</th>
						...
						<tbody><?php if(isset($tim)) : ?> <?php foreach($tim as $list) : ?>
							...
							<td><a href="<?php echo base_url(); ?>parameter/tim-anggaran/tim/<?php echo $list->id_kode; ?>"><?php echo $list->skpd_nama; ?></a></td>
