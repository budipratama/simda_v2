	...
	<h3 class="page-title">Parameter <small> Tim Anggaran</small></h3>		
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<!-- BEGIN FORM -->
				<input type="hidden" value="<?php printf( "%01d", $nomor->no++ ); ?>" />
				<form action="<?php echo site_url('parameter/tim-anggaran/add');?>" class="form-horizontal" method="post"><br>
					<div class="form-group">
						<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-3" for="aaa_kode">Kode Tim <span class="required">*</span> :</label>
							<div class="col-md-1">
							<input type="text" class="form-control" name="aaa_kode" id="aaa_kode" maxlength="1" onkeypress="return isNumberKey(event)" required="required">
							</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-1">
							<input type="text" class="form-control" name="bbb_kode" id="bbb_kode" value="<?php printf( "%01d", $nomor->no++ ); ?>" readonly="readonly">
							</div>
						</div>
						</div>
					</div>	
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
							<input type="text" class="form-control" name="ccc_kode" id="ccc_kode" required="required">
							</div>
						</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
							<!--<input type="text" class="form-control" name="ddd_kode" id="ddd_kode" maxlength="18" onkeypress="return isNumber(event)" required="required">-->
							<input type="text" class="form-control" name="ddd_kode" id="ddd_kode" required="required">
							</div>
						</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
							<input type="text" class="form-control" name="eee_kode" id="eee_kode" required="required">
							</div>
						</div>
						</div>
					</div>
