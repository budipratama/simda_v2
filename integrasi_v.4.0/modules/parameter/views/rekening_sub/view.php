                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        <li role="presentation" class="active"><a href="#home_animation_1" data-toggle="tab">Obyek</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1">
											...
											<tbody><?php if(isset($obyek)):?><?php foreach($obyek as $list):?>
												<tr>
													<td style="text-align:center;"><?php echo $list->no;?></td>													
													<td><a href="<?php echo site_url('parameter/rekening-sub/rincian/'.$list->list_id);?>"><?php echo $list->obyek;?></a></td>
												</tr>
