				...
				<form class="form-horizontal" method="post">
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-2">						
							<?php combobox('db', $rek, 'hidden1', 'kode', 'akun_nama', '', 'show_form_rek_by_kelompok();', 'Pilih Akun', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
							</div>
						</div>
						</div>
						<div class="col-md-5">
						...
						<div class="portlet" align="right">
							<input class="btn btn-success" type="submit" name="button3" id="button3" value="Pilih" onclick="cekdata(); window.opener.document.getElementById('rek1').value = kembali1; window.opener.document.getElementById('rek2').value = kembali2; window.opener.document.getElementById('rek3').value = kembali3; window.opener.document.getElementById('rek4').value = kembali4; window.opener.document.getElementById('rek5').value = kembali5; window.opener.document.getElementById('rek6').value = kembali6; window.close(); " />
...
<script language="javascript">
	...
	function show_form_rek_by_kelompok(){
		...
		load('parameter/korolari/tampil_combobox_rek_by_kelompok/'+hidden1, '#tampil_combobox_rek_by_kelompok');
		load('parameter/korolari/tampil_combobox_kelompok_by_jenis/', '#tampil_combobox_kelompok_by_jenis');
	...
	function show_form_rek_by_jenis(){
		...
		load('parameter/korolari/tampil_combobox_rek_by_jenis/'+hidden2, '#tampil_combobox_rek_by_jenis');
		load('parameter/korolari/tampil_combobox_jenis_by_obyek/', '#tampil_combobox_jenis_by_obyek');
		load('parameter/korolari/tampil_combobox_obyek_by_rincian/', '#tampil_combobox_obyek_by_rincian');
	}
