		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a href="<?php echo site_url('parameter/unit-organisasi/sub');?>"> Sub Unit</a></li>
				</ol>
				</div>
			</div>
		</div>
				<div class="col-md-12">
                	<div class="portlet" align="right">
						...
						<a href="<?php echo site_url('parameter/unit-organisasi/subadd');?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Sub Unit</a>						
                    </div>
                </div>
			<div class="clearfix"></div>
			<?php if ($this->session->flashdata('success')) { echo $this->session->flashdata('success');} ?>
            <script>
				var ajax_source_url = '<?php echo site_url($this->uri->segment(1) . '/' . $this->uri->segment(2) . '/datatablesub'); ?>';
				var ajax_source_field =   [ { "data": "nomor" },
											{ "data": "bidang_unit_nama" },
											{ "data": "bidang_sub" },
											{ "data": "Actions" } ];
			</script>
			<!-- END PAGE HEADER-->
			...
			<div class="col-md-12">
				...
				<div class="panel-heading"><i class="fa fa-bars"></i> Data Sub Unit</div>
				<div class="panel-body">
						<div class="portlet-body">
							...
							<tr>
								...
								<th class="hidden-xs" style="text-align:center;">Sub Unit</th>
