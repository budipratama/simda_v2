...
<script language="javascript">
	...
	function show_form_rek_by_kelompok(){
		...
		load('parameter/rekening-sap/tampil_combobox_obyek_by_rincian/', '#tampil_combobox_obyek_by_rincian');
	}
	...
	function show_form_obyek_by_rincian(){
		...
		load('parameter/rekening-sap/tampil_combobox_obyek_by_rincian/'+hidden4, '#tampil_combobox_obyek_by_rincian');
	}
</script>