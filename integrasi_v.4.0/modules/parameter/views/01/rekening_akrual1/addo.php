		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a href="<?php echo site_url('parameter/rekening/addo');?>"> Tambah</a></li>
				</ol>
				</div>
			</div>
		</div>
            ...
            <div class="panel panel-info">
				...
				<!-- BEGIN FORM -->
				<form action="<?php echo site_url('parameter/rekening/inserto');?>" class="form-horizontal" method="post"><br>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
							<input type="text" class="form-control" name="obyek" id="obyek" placeholder="Input Obyek ..." required="required">
							</div>
						</div>
						</div>
					</div>					
