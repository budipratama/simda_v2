...
<div class="side-body padding-top">
	<h3 class="page-title">Parameter Rekening <small> obyek</small></h3>		
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-md-12">
                	<div class="portlet" align="right">
						...
						<a href="<?php echo site_url('parameter/rekening/addj');?>" class="btn btn-success"><i class="fa fa-plus"></i> Obyek</a>
                    </div>
                </div>		
