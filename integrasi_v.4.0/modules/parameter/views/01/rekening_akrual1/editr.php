	...
	<h3 class="page-title">Parameter <small> rekening</small></h3>		
		<div class="row">
            ...
            <div class="panel panel-warning">
				...
				<!-- BEGIN FORM -->
				<form action="<?php echo site_url('parameter/rekening/updater/'.$kode);?>" class="form-horizontal" method="post"><br>
				<input type="hidden" name="kode" value="<?php echo $kode; ?>" />
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
							<?php combobox('db', $obyek, 'ddd_kode', 'kode', 'obyek_nama', $obyek_, 'show_form_obyek_by_rincian();', 'Pilih Obyek ...', 'class="select2_category form-control" required="required" placeholder="" readonly="readonly" disabled'); ?>
							</div>
						</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
							<input type="text" class="form-control" name="rincian" id="rincian" value="<?php echo $rincian; ?>" required="required">
							</div>
						</div>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-3" for="peraturan">Peraturan :</label>
							<div class="col-md-8">
							<input type="text" class="form-control" name="peraturan" id="peraturan" value="<?php echo $peraturan; ?>" required="required">
							</div>
						</div>
						</div>
					</div>					
