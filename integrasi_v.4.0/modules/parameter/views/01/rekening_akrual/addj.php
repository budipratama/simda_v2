		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<?php echo form_open('parameter/rekening_akrual/addj'); ?>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							...
							<table class="table table-striped table-bordered table-hover" width="50%" cellspacing="5" cellpadding="5">
								...
								<th style="text-align:center; width:150px">Saldo Normal</th>
									...
									<ul>
										<tr>
										<td style="text-align:center;"><input type="text" class="form-control" name="aaa_kode" value=<?php echo $akun->no; ?> readonly="readonly"></td>
										<td style="text-align:center;"><input type="text" class="form-control" name="bbb_kode" value=<?php echo $kelompok->no; ?> readonly="readonly"></td>
										<td><input type="text" class="form-control" name="ccc_kode" value="<?php echo $jenis->no; ?>" required="required"></td>
										<td><input type="text" class="form-control" name="ddd_kode" placeholder="Input Jenis ..." required="required"></td>
										<td><?php combobox('db', $saldo, 'eee_kode', 'tipe_nama', 'tipe_nama', $saldo_, '', 'Pilih Saldo ...', 'class="select2_category form-control" tabindex="1" required="required"'); ?></td>
										</tr>
									</ul>
							</table>
								<?php $angka = $jenis->no++; $no = sprintf("%01s",$jenis->no); $nomor = sprintf("%02s",$jenis->no);?>							
