			...
			<div class="col-xs-12">
				...
				<div class="col-md-12">
					...
					<a href="<?php echo site_url('parameter/rekening');?>" class="btn btn-default"><i class="fa fa-reply"></i> Kembali</a>
						<a class="btn btn-success" title="Tambah" href="<?php echo base_url(); ?>parameter/akrual/addo/<?php echo $jenis->kode; ?>"><i class="fa fa-plus"> Obyek</i></a>
                    </div>
                </div>
			<!-- END PAGE HEADER-->
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								<thead><tr>
									...
									<tbody><?php if($uncompleted) : ?><?php foreach($uncompleted as $task) : ?>
										...
										<td><a href="<?php echo base_url(); ?>parameter/akrual/rincian/<?php echo $task->task_id; ?>"><?php echo $task->obyek_nama; ?></a></td>
										<td style="text-align:center;">										
										<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo base_url(); ?>parameter/akrual/edito/<?php echo $task->task_id; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-pencil"></i></a>
										<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>parameter/akrual/deleteo/<?php echo $list->kode; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-trash-o"></i></a>
										</td>
										</tr>
									<?php endforeach; ?></ul>
