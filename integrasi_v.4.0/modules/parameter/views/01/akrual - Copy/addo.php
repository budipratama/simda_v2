		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<form action="<?php echo site_url('parameter/akrual/addo/'.$kode->id);?>" class="form-horizontal" method="post" >
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							...
							<table class="table table-striped table-bordered table-hover" width="50%" cellspacing="5" cellpadding="5">
								...
								<th style="text-align:center;">Uraian Rekening Obyek</th>
									...
									<ul>
										<tr>
										<input type="hidden" class="form-control" name="aaa_kode" value=<?php echo $jenis->akun; ?> readonly="readonly">
										<input type="hidden" class="form-control" name="bbb_kode" value=<?php echo $jenis->kelompok; ?> readonly="readonly">
										<input type="hidden" class="form-control" name="ccc_kode" value=<?php echo $jenis->kode; ?> readonly="readonly">										
										<td><input type="text" class="form-control" name="ddd_kode" value=<?php printf( "%01d", $obyek->no ); ?> placeholder="Kode ..." readonly="readonly"></td>
										<input type="hidden" class="form-control" name="fff_kode" value=<?php printf( "%02d", $obyek->no ); ?> placeholder="Kode ..." readonly="readonly">
