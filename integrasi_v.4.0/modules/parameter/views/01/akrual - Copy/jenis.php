			...
			<div class="col-xs-12">
				...
				<div class="col-md-12">
					...
					<a href="<?php echo site_url('parameter/rekening');?>" class="btn btn-default"><i class="fa fa-reply"></i> Kembali</a>
						<a class="btn btn-success" title="Tambah" href="<?php echo base_url(); ?>parameter/akrual/addj/<?php echo $list->kode; ?>"><i class="fa fa-plus"> Jenis</i></a>
                    </div>
                </div>
			<!-- END PAGE HEADER-->
						...
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								<thead><tr>
									...
									<th style="text-align:center; width:60px">Saldo Normal</th>
									...
									<tbody><?php if($uncompleted) : ?><?php foreach($uncompleted as $task) : ?>
										...
										<td><a href="<?php echo base_url(); ?>parameter/akrual/obyek/<?php echo $task->task_id; ?>"><?php echo $task->jenis_nama; ?></a></td>
										<td style="text-align:center;"><?php echo $task->saldo_id; ?></a></td>
										<td style="text-align:center;">										
										<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo base_url(); ?>parameter/akrual/editj/<?php echo $task->task_id; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-pencil"></i></a>
										<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>parameter/akrual/deletej/<?php echo $list->kode; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-trash-o"></i></a>
										</td>
										</tr>
										<?php endforeach; ?></ul>
