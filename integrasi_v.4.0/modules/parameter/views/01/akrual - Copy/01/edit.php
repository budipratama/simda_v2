	...
	<h3 class="page-title">Parameter <small> rekening</small></h3>		
		<div class="row">
            ...
            <div class="panel panel-warning">
				...
				<!-- BEGIN FORM -->
				<form action="<?php echo site_url('parameter/rekening/updatej/'.$kode);?>" class="form-horizontal" method="post"><br>
				<input type="hidden" name="kode" value="<?php echo $kode; ?>" />
					...
					<div class="form-group">
						<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-3" for="jenis">Jenis :</label>
							<div class="col-md-8">
					...
					<div class="form-group">
						<div class="col-md-10">
						<div class="form-group">
							<label class="control-label col-md-3" for="fff_kode">Saldo Normal :</label>
							<div class="col-md-2">
							<?php combobox('db', $saldo, 'sss_kode', 'tipe_kode', 'tipe_nama', $saldo_, '', 'Pilih Saldo ...', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
							</div>
						</div>
						</div>
					</div>					
