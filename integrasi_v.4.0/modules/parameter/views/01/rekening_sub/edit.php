		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<form action="<?php echo site_url('parameter/rekening_sub/edit/'.$this_task->kode);?>" class="form-horizontal" method="post"><br>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							...
							<table class="table table-striped table-bordered table-hover" width="50%" cellspacing="5" cellpadding="5">
								...
								<th style="text-align:center;">Uraian Sub Rincian Belanja Modal</th>
									...
									<ul>
										<tr>
										<td style="text-align:center;"><input type="text" class="form-control" name="ggg_kode" value="<?php echo $this_task->no; ?>" readonly="readonly"></td>
