	...
	<h3 class="page-title">Parameter <small> Rekening Sub Rincian Belanja Modal</small></h3>		
		<div class="row">
            ...
            <div class="panel panel-warning">
				...
				<!-- BEGIN FORM -->
				<form action="<?php echo site_url('parameter/rekening_sub/update/'.$kode);?>" class="form-horizontal" method="post"><br>
				<input type="hidden" name="kode" value="<?php echo $kode; ?>" />
					...
					<div class="form-group">
						...
						<div class="form-group" id="tampil_combobox_kelompok_by_jenis">
							...
							<div class="col-md-8">
							<?php combobox('db', $obyek, 'ddd_kode', 'kode', 'obyek_nama', $obyek_, '', 'Pilih Obyek', 'class="select2_category form-control" tabindex="1" required="required"'); ?>
							</div>
						</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
							<input type="text" class="form-control" name="sub_rincian" id="sub_rincian" placeholder="Input Sub Rincian ..." value="<?php echo $sub_rincian; ?>" required="required">
							</div>
						</div>
						</div>
					</div>					
