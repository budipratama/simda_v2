		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="portlet-body" style="display: block;">                          
					<a href="<?php echo site_url('parameter/rekening/addr');?>" class="icon-btn"><i class="fa fa-plus"></i><div>Rincian Obyek</div></a>
					</div>							
				</div>
				<div class="panel-body">				
				<!-- BEGIN FORM -->
				<div class="step">
					<ul class="nav nav-tabs nav-justified" role="tablist">
						<li role="step">
							<a href="<?php echo site_url('parameter/rekening');?>">
						...
						<li role="step" class="active step-success">
							<a href="#step3" id="step3-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">  
						...
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							<div class="portlet-body">											
								...
								<thead><tr>
									...
									<th style="width:25px">Obyek</th>
									<th style="width:25px">Rincian</th>
									<th style="text-align:center; width:900px">Uraian Rincian Obyek</th>
...
<!-- END CONTENT -->
	<script>
	var ajax_source_url = '<?php echo site_url($this->uri->segment(1) . '/' . $this->uri->segment(2) . '/rincianv'); ?>';
	var ajax_source_field =	  [ { "data": "nomor" }, { "data": "akun" }, { "data": "kelompok" }, { "data": "jenis" }, { "data": "obyek" }, { "data": "no" }, { "data": "rincian_nama" }, { "data": "Actions" } ];
