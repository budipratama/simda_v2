                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">                                        
                                        ...
                                        <li><a title="Kembali" href="<?php echo site_url('parameter/akrual/obyek/'.$obyek->jenis);?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row clearfix">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
										...
										<li><p class="col-cyan"><a href="<?php echo site_url('parameter/akrual/kelompok/'.$obyek->akun);?>"><i class="material-icons">keyboard_arrow_left</i>Kelompok</a><p></li>
										<li><p class="col-cyan"><a href="<?php echo site_url('parameter/akrual/jenis/'.$obyek->kelompok);?>"><i class="material-icons">keyboard_arrow_left</i>Jenis</a><p></li>
										<li><p class="col-cyan"><a href="<?php echo site_url('parameter/akrual/obyek/'.$obyek->jenis);?>"><i class="material-icons">keyboard_arrow_left</i>Obyek</a><p></li>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<thead><tr>
												...
												<th style="text-align:center;">Uraian Rincian Akrual Obyek</th>
											...
											<tbody><?php if($rincian) : ?><?php foreach($rincian as $task) : ?>
												<tr>
													...
													<a class="btn bg-red btn-circle waves-effect waves-circle waves-float" title="Hapus" onclick="return confirm('Are you sure?')" href="<?php echo site_url('parameter/akrual/deleter/'.$task->list_id);?>"><i class="material-icons">delete</i></a>
													</td>
												</tr>
											<?php endforeach; ?></ul>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data Kode Rekening Akrual Rincian <font color="red"><strong>"Permanen!"</strong></font>
				</div>
...
<a href="#warningHapus" data-toggle="modal"></a>
	<div id="warningHapus" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data Rekening Akrual Rincian <font color="red"><strong>"Permanen!"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn blue" data-dismiss="modal">OK</button>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<center><h3 class="modal-title">Rekening Akrual Rincian</h3></center>
			  </div>
			<div class="modal-body form">
				<form action="<?php echo site_url('parameter/akrual/addr');?>" id="form" class="form-horizontal" method="post" >
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="col-md-10">
									...
									<div class="form-line">
										...
										<label class="form-label">Uraian Rekening Akrual Rincian</label>
									</div>
									</div>
								</div><br><br><br>
								<div class="body">
	...
	<div class="modal fade" id="editRincian" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-body form">
				<form action="<?php echo site_url('parameter/akrual/editr');?>" id="form1" class="form-horizontal" method="post" >
    ...
    function add_rincian() {
		...
		$('.modal-title').text('Tambah Rekening Akrual Rincian'); // Set title to Bootstrap modal title
    }
    ...
    function edit_rincian(id) {
		...
		$.ajax({
			url : "<?php echo site_url('parameter/akrual/ajax_rincian/')?>/" + id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
				$('[name="kode"]').val(data.kode);
				$('[name="ddd_kode"]').val(data.kd_akrual_5);
				$('[name="eee_kode"]').val(data.nm_akrual_5);
				$('[name="ppp_kode"]').val(data.peraturan);
				$('[name="obyek"]').val(data.kd_akrual_4);
				$('[name="status"]').val(data.status);
				$('[name="peraturan"]').val(data.peraturan);
				$('#editRincian').modal('show'); // show bootstrap modal when complete loaded
				$('.modal-title').text('Edit Rekening Akrual Rincian'); // Set title to Bootstrap modal title				
			},
