                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tr>
												...
												<th style="text-align:center;">Uraian Rekening Akrual Kelompok</th>
											</tr>
											</thead>
											<tbody><?php if($kelompok):?><?php foreach($kelompok as $task):?>
												<tr>
													<td style="text-align:center;"><?php echo $akun->no; ?></td>
													<td style="text-align:center;"><?php echo $task->no; ?></a></td>
													<td><a href="<?php echo site_url('parameter/akrual/jenis/'.$task->list_id);?>"><?php echo $task->kelompok;?></a></td>
												</tr>
