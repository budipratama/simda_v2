<!-- Main Content -->
	<section class="content">
		<h2>Parameter<small> mapping korolari sap</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					<li><a href="<?php echo site_url('dashboard');?>"><i class="material-icons">home</i> Home</a></li>
					<li><a href="<?php echo site_url('parameter');?>"> Parameter</a></li>
					<li><a href="<?php echo site_url('parameter/rekening-sap');?>"> Korolari SAP</a></li>
				</ol>
			</div>
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<h2>Rekening Mapping Korolari SAP<small>Data Korolari SAP</small></h2>
					...
					<div class="body">
                        <div class="row clearfix">
							...
							<div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1">
								...
								<p><form action="#" class="form-horizontal" method="POST">
									<div class="body">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="col-md-5">
											<p>Rekening Permendagri 13 : <b id='rek6'></b></p>
										</div>												
										<div class="col-md-1">
							...
							<div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1">
								...
								<p><table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									<tbody><?php if(isset($sap)):?><?php foreach($sap as $list):?>
									<tr>
						...
						<div class="row clearfix">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="col-md-6">
									<p><b>Akun <span class="required">*</span> :</b></p>
									<div class="form-group">
									<?php combobox('db', $lra, 'drek1_kode', 'kode', 'nm_rek_1', $akun_, 'show_form_akun_by_kelompok2();', 'Pilih Akun', 'class="form-control" required');?>
									</div>
								</div><br><br><br><br>
								<div class="col-md-6">
									<p><b>Kelompok <span class="required">*</span> :</b></p>
...
<!-- END CONTENT -->
	...
	function show_form_akun_by_kelompok1(){
		...
		load('parameter/rekening_sap/tampil_combobox_akun_by_kelompok1/'+rek1_kode, '#tampil_combobox_akun_by_kelompok1');
		load('parameter/rekening_sap/tampil_combobox_kelompok_by_jenis1/', '#tampil_combobox_kelompok_by_jenis1');
		load('parameter/rekening_sap/tampil_combobox_jenis_by_obyek1/', '#tampil_combobox_jenis_by_obyek1');
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian1/', '#tampil_combobox_obyek_by_rincian1');
	}
	
	function show_form_kelompok_by_jenis1(){
		var rek2_kode = $('select[name=rek2_kode]').val();
		load('parameter/rekening_sap/tampil_combobox_kelompok_by_jenis1/'+rek2_kode, '#tampil_combobox_kelompok_by_jenis1');
		load('parameter/rekening_sap/tampil_combobox_jenis_by_obyek1/', '#tampil_combobox_jenis_by_obyek1');
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian1/', '#tampil_combobox_obyek_by_rincian1');
	}
	...
	function show_form_jenis_by_obyek1(){
		...
		load('parameter/rekening_sap/tampil_combobox_jenis_by_obyek1/'+rek3_kode, '#tampil_combobox_jenis_by_obyek1');
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian1/', '#tampil_combobox_obyek_by_rincian1');
	}
	
	function show_form_obyek_by_rincian1(){
		var rek4_kode = $('select[name=rek4_kode]').val();
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian1/'+rek4_kode, '#tampil_combobox_obyek_by_rincian1');
	}
	
	function show_form_akun_by_kelompok2(){
		var drek1_kode = $('select[name=drek1_kode]').val();
		load('parameter/rekening_sap/tampil_combobox_akun_by_kelompok2/'+drek1_kode, '#tampil_combobox_akun_by_kelompok2');
		load('parameter/rekening_sap/tampil_combobox_kelompok_by_jenis2/', '#tampil_combobox_kelompok_by_jenis2');
		load('parameter/rekening_sap/tampil_combobox_jenis_by_obyek2/', '#tampil_combobox_jenis_by_obyek2');
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian2/', '#tampil_combobox_obyek_by_rincian2');
	}
	
	function show_form_kelompok_by_jenis2(){
		var drek2_kode = $('select[name=drek2_kode]').val();
		load('parameter/rekening_sap/tampil_combobox_kelompok_by_jenis2/'+drek2_kode, '#tampil_combobox_kelompok_by_jenis2');
		load('parameter/rekening_sap/tampil_combobox_jenis_by_obyek2/', '#tampil_combobox_jenis_by_obyek2');
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian2/', '#tampil_combobox_obyek_by_rincian2');
	}
	...
	function show_form_jenis_by_obyek2(){
		...
		load('parameter/rekening_sap/tampil_combobox_jenis_by_obyek2/'+drek3_kode, '#tampil_combobox_jenis_by_obyek2');
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian2/', '#tampil_combobox_obyek_by_rincian2');
	}
	
	function show_form_obyek_by_rincian2(){
		var drek4_kode = $('select[name=drek4_kode]').val();
		load('parameter/rekening_sap/tampil_combobox_obyek_by_rincian2/'+drek4_kode, '#tampil_combobox_obyek_by_rincian2');
	}
	</script>
