<!-- Main Content -->
   <section class="content">
		<h2>Parameter<small> rekening potongan spm</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					<li><a href="<?php echo site_url('dashboard');?>"><i class="material-icons">home</i> Home</a></li>
					<li><a href="<?php echo site_url('parameter');?>"> Parameter</a></li>
					<li><a href="<?php echo site_url('parameter/belanja-wajib');?>"> Rekening Potongan SPM</a></li>
				</ol>
			</div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<h2>Rekening<small>Data Potongan SPM</small></h2>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                                    
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1">
											...
											<thead>
											<tr>
												<th style="text-align:center; width:50px">Kode</th>
												<th style="text-align:center; width:80px">Rekening</th>
												<th style="text-align:center;">Uraian Rekening</th>
												<th style="text-align:center; width:80px">Potongan</th>
											...
											<tbody><?php if(isset($potongan)):?><?php foreach($potongan as $list):?>
												<tr>
													<td style="text-align:center;"><?php echo $list->rekening;?></td>
													<td style="text-align:center;"><?php echo $list->akun,'.',$list->kelompok,'.',$list->jenis,'.',$list->obyek,'.',$list->rincian;?></td>													
													<td><?php echo $list->nm_rekening;?></td>
													<td style="text-align:center;"><?php echo $list->potongan;?></td>
													<td><?php echo $list->nm_potongan;?></td>
													<td></td>
												</tr>
...
<div class="modal fade" id="addBelanja" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-body form">
				<form action="<?php echo site_url('parameter/rekening-potongan/add');?>" id="form" class="form-horizontal" method="POST">
...
<script type="text/javascript">
    ...
    function add_belanja() {
		...
		$('.modal-title').text('Tambah Rekening Potongan SPM'); // Set title to Bootstrap modal title
    }
    ...
    function edit_jenis(id) {
		...
		$.ajax({
			url : "<?php echo site_url('parameter/rekening_potongan/ajax_potongan/')?>/" + id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
				...
				$('.modal-title').text('Edit Rekening Potongan SPM'); // Set title to Bootstrap modal title				
			},
