...
class Akrual extends CI_Controller {
	...
	public function editj($id) {
		$admin_log 	= $this->auth->is_login_admin(); {
			...
			$container['content']['view']					= 'parameter/akrual/editj';
				...
				redirect('parameter/akrual/jenis/'.$jenis->kd_rek_2.'/#warningEdit', 'refresh');
			}
		}
	}
	...
	public function edito($id) {
		$admin_log 	= $this->auth->is_login_admin(); {
			...
			$container['content']['view']					= 'parameter/akrual/edito';
				...
				$this->session->set_flashdata('success','<div class="alert fresh-color alert-warning fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Warning!</strong> Data "PERMANENT"</div>');
				redirect('parameter/akrual/obyek/'.$obyek->kd_rek_3.'/#warningEdit', 'refresh');
			}
		}
	}
	...
	public function editr($id) {
		$admin_log 	= $this->auth->is_login_admin(); {
			...
			$container['content']['view']					= 'parameter/akrual/editr';
				...
				$this->session->set_flashdata('success','<div class="alert fresh-color alert-warning fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Warning!</strong> Data "PERMANENT"</div>');
				redirect('parameter/akrual/rincian/'.$rincian->kd_rek_4.'/#warningEdit', 'refresh');
			}
		}
	}
	...
	public function delete() {
		...
		if ($jenis->status == 2) {
			...
			redirect('parameter/akrual/jenis/'.$jenis->kd_rek_2.'/#warningHapus', 'refresh');
			}
			redirect('parameter/akrual/jenis/'.$jenis->kd_rek_2, 'refresh');
		}
	}
	...
	public function deleteo() {
		...
		if ($obyek->status == 2) {
			...
			$this->session->set_flashdata('success','<div class="alert fresh-color alert-danger fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Warning!</strong> Data "PERMANENT"</div>');
			redirect('parameter/akrual/obyek/'.$obyek->kd_rek_3.'/#warningHapus', 'refresh');
			}
			redirect('parameter/akrual/obyek/'.$obyek->kd_rek_3, 'refresh');
		}
	}
	...
	public function deleter() {
		...
		if ($rincian->status == 2) {
			...
			$this->session->set_flashdata('success','<div class="alert fresh-color alert-danger fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Warning!</strong> Data "PERMANENT"</div>');
			redirect('parameter/akrual/rincian/'.$rincian->kd_rek_4.'/#warningHapus', 'refresh');
			}
			redirect('parameter/akrual/rincian/'.$rincian->kd_rek_4, 'refresh');
		}
	}
