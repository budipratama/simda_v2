...
class Murni extends CI_Controller {
	...
	public function edit($id) {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/edit';
			...
			redirect('anggaran-kas/murni/belanja/'.$id_kode, 'refresh');
			}
		}
    }
	...
	public function deleteb() {
		...
		$rka 		= $this->Rka_model->getOnly('anggaran_kode', array('kode'=>$kode));			
			...
			redirect('anggaran-kas/murni/belanja/'.$rka->anggaran_kode, 'refresh');
		}
	}
	...
	public function rincian() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/rincian';		
	...
	public function addr() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] 	= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/addr';
			...
			redirect('anggaran-kas/murni/rincian/'.$id_kode);
		}
	...
	public function editr($id) {
		...
		$this->form_validation->set_rules('aaa_kode','Uraian','trim|xss_clean');
			...
			if($this->form_validation->run() == FALSE){	
				$container['sidebar']['view']						= 'admin/sidebar';
				$container['sidebar']['dataset']['aktive_menu'] 	= 62;	
				$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/editr';
			...
			redirect('anggaran-kas/murni/rincian/'.$id_kode, 'refresh');
			}
		}
    }
	...
	public function deleter() {
		$admin_log 	= $this->auth->is_login_admin(); {
			...
			redirect('anggaran-kas/murni/rincian/'.$rincian->rka, 'refresh');
		}
	}
	...
	public function sub() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu']		= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/sub';		
	...
	public function adds($list_id = null) {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu']		= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/adds';
			...
			redirect('anggaran-kas/murni/sub/'.$id_kode);
		}
	...
	public function edits($id) {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu']		= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/edits';
		...
		$container['sub']									= $this->Rka_model->get_sub($kode);
			...
			$this->session->set_flashdata('success','<div class="alert fresh-color alert-warning fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><strong>Success!</strong> Data "RINCIAN BELANJA" telah berhasil diubah</div>');
			redirect('anggaran-kas/murni/sub/'.$id_kode, 'refresh');
			}
		}
    }
	
	public function vrencana() {
		$admin_log 	= $this->auth->is_login_admin();
		$kode 		= $this->uri->segment(4);
		$anggaran 	= $this->Anggaran_model->getOnly('tipe_kode', array('kode'=>$kode));
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu']		= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/vrencana';
	...
	public function addrencana() {
		...
		$container['sidebar']['view']						= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu']		= 62;	
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/addrencana';
	...
	{	
		...
		$rka = $this->Rka_model->get('rka.*', array('rka.kode'=>$this->uri->segment(4)));		
		$sess_laporan['content']['dataset']['kode']		= $rka->kode;
		...
		if ($this->input->post('tahun')) { 
			...
			redirect('anggaran-kas/murni/preview', 'refresh');
		}
	...
	{	
	 ...
	 function hasil2(){
        ...
        $html = $this->load->view('anggaran-kas/murni/belanja_langsung/hasil2', $laporan, true);
        $filename = 'Message';
        $paper = 'A4';
        $orientation = 'potrait';
	...
	public function viewa() {
		$admin_log 	= $this->auth->is_login_admin();
		{
			...
			$rka = $this->Rka_model->get_ak('rka.anggaran_kode, skpd.skpd_kode, skpd.skpd_nama, anggaran.kegiatan as id_kegiatan, anggaran.tahun, program.program as program_nama, akun.no as id_akun, kelompok.no as id_kelompok, jenis.no as id_jenis, obyek.no as id_obyek, rincian.no as id_rincian, rincian.rincian_nama as nama_rincian,', array('rka.anggaran_kode'=>$this->uri->segment(4)));	
			$container['content']['dataset']['id_anggaran']	= $rka->anggaran_kode;
	...
	{	
		...
		if ($this->input->post('tahun')) { 
			$this->session->unset_userdata('is_sess_laporan');
			$this->session->set_userdata('is_sess_laporan', $sess_laporan);
			redirect('anggaran-kas/murni/previewa', 'refresh');
		}
