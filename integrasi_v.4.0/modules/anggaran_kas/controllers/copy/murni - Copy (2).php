...
class Murni extends CI_Controller {
	...
	public function rencana() {
		...
		$container['content']['view']						= 'anggaran_kas/murni/belanja_langsung/rencana';
			...
			$rka = $this->Rka_model->get_ak('rka.anggaran_kode, skpd.skpd_nama, anggaran.kegiatan as id_kegiatan, program.program as program_nama, akun.no as id_akun, kelompok.no as id_kelompok, jenis.no as id_jenis, obyek.no as id_obyek, rincian.no as id_rincian, rincian.rincian_nama as nama_rincian,', array('rka.anggaran_kode'=>$this->uri->segment(4)));	
			$container['content']['dataset']['id_anggaran']	= $rka->anggaran_kode;
	...
	public function viewa() {
		$admin_log 	= $this->auth->is_login_admin();
		{
			...
			$rka = $this->Rka_model->get_ak('rka.kode, rka.anggaran_kode, rka.tahun, skpd.skpd_kode, skpd.skpd_nama, anggaran.kegiatan as id_kegiatan, program.program as program_nama, akun.no as id_akun, kelompok.no as id_kelompok, jenis.no as id_jenis, obyek.no as id_obyek, rincian.no as id_rincian, rincian.rincian_nama as nama_rincian,', array('rka.anggaran_kode'=>$this->uri->segment(4)));	
			$container['content']['dataset']['kode']		= $rka->kode;
			$container['content']['dataset']['id_anggaran']	= $rka->anggaran_kode;
			$container['content']['dataset']['tahun']		= $rka->tahun;
			$container['content']['dataset']['skpd']		= $rka->skpd_nama;
