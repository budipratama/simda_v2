						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="body">
									<div class="row clearfix">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<form action="<?php echo $kode;?>" name="formku" method="POST">
										<div class="row clearfix">
										<div class="col-md-6">
										...
										<div class="col-md-offset-11">
											<button class="btn btn-primary waves-effect" type="submit" name="Hitung" id="Hitung">Bagi Rata</button>																	
															...
															<div class="row clearfix">
																...
																<div class="form-group form-float">
																	<div class="form-line">
																		<input type="text" class="form-control" name="ojurusan" id="hasil" value="<?php echo $a;?>" maxlength="16" style="text-align:right;">
...
function tekan() {
   var jurusanstr = (document.formku.jurusan.value);
   document.formku.ojurusan.value = jurusanstr;
}
</script>