                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        ...
                                        <li><a href="<?php echo site_url('anggaran-kas/murni/browse/'.$kode);?>">Browse</a></li>
                                        <li><a href="<?php echo site_url('anggaran-kas/murni/rencana/'.$kode);?>">Rencana</a></li>
                                    </ul>
                                    <!-- Tab panes -->
                                        ...
                                        <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1">
											...
											<tbody><?php if($anggaran_bl) : ?><?php foreach($anggaran_bl as $task) : ?>
												<tr>
													...
													<td><a href="<?php echo base_url(); ?>anggaran-kas/murni/rincian/<?php echo $task->task_id; ?>"><?php echo $task->nama_rincian; ?></a></td>
