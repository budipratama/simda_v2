                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<form action="<?php echo site_url('anggaran-kas/murni/belanja_langsung');?>" id="form_validation" enctype="multipart/form-data" method="POST">
											...
											<div class="form-group">
												<div class="col-md-offset-9">
													...
													<a href="<?php echo base_url(); ?>anggaran-kas/murni/belanja/<?php echo $kode;?>" class="btn btn-default">Batal</a>
												</div>
											</div>
											</form>
											</div>
