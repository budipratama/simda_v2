							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="body">
									...
									<form action="" name="formku" method="POST">
										...
										<input type="text" id="angka1" value="<?php echo ($task->totalRKA); ?>">
													<?php } ?>
												</div>
											</div>
										</div>
										...
										<input type="text" name="" id="last" value="12">
										<input type="text" name="" id="angka2" value="12">
...
<input type="text" id="jumlah">
        ...
        <input type="text" id="hasil2" readonly/><br/>
        <input type="text" id="hasil1" readonly/><br/>
	</form>
...
<script type="text/javascript">
	function jumlah()
	{
		...
		hasil2 = parseInt(angka1) / parseInt(angka2);
		document.getElementById('hasil2').value=hasil2;
		hasil1 = parseInt(angka1) / parseInt(angka2);
		document.getElementById('hasil1').value= Math.round (hasil1).toFixed(-4);
	}
</script>