                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">                                     
                                        <li><a title="Kembali" href="<?php echo base_url(); ?>anggaran-kas/murni/rincian/<?php echo $rincian->id_rka;?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<form action="<?php echo site_url('anggaran-kas/murni/editr/'.$kode);?>" class="form-horizontal" method="post"><br>
											...
											<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
												...
												<div class="form-group">
													<div class="col-md-offset-9">
														...
														<a href="<?php echo base_url(); ?>anggaran-kas/murni/rincian/<?php echo $rincian->id_rka;?>" class="btn btn-default">Batal</a>
													</div>
												</div>
												</div>
											</div>
