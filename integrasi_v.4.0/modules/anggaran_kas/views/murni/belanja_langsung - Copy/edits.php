							...
							<ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">                                     
                                        <li><a title="Kembali" href="<?php echo base_url(); ?>anggaran-kas/murni/sub/<?php echo $rincian; ?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">										
											<form action="<?php echo site_url('anggaran-kas/murni/edits/'.$kode);?>" id="form_validation" class="form-horizontal" method="post" name="autoSumForm" onSubmit="return validasi()"><br>
														...
														<div class="row clearfix">
															...
															<div class="row clearfix">
																...
																<div class="form-group form-float">
																	<div class="form-line">
																		<input type="text" class="form-control" name="bbb_kode" id="satuan" value="<?php echo $harga; ?>" maxlength="16" style="text-align:right;" onkeypress="return isNumber(event)" onkeyup="totalSum()" placeholder="0" required="required">
															...
															<div class="row clearfix">
																...
																<div class="form-group form-float">
																	<div class="form-line">
																		<input type="text" class="form-control" name="firstBox" value="<?php echo $volume; ?>" onFocus="startCalc();" onBlur="stopCalc();" maxlength="16" id="volume1" style="text-align:right;" onkeypress="return isNumber(event)" onkeyup="totalSum()" placeholder="0" required="required">
															...
															<div class="row clearfix">
																...
																<div class="form-group form-float">
																	<div class="form-line">
																		...
																		<input type="text" class="form-control" name="thirdBox" id="thirdBox" value="<?php echo $volume; ?>" style="text-align:right;font-weight:bold;" placeholder="0" readonly="readonly">
															...
															<div class="row clearfix">
																...
																<div class="form-group form-float">
																	<div class="form-line">
																		<input type="text" class="form-control" id="total_sum1" value="<?php echo $total; ?>" style="text-align:right;font-weight:bold;" placeholder="0" readonly="readonly">
																		<input type="hidden" class="form-control" name="total_sum" id="total_sum" value="<?php echo $total; ?>" style="text-align:right;font-weight:bold;" placeholder="0" readonly="readonly">
															...
															<div class="form-group">
																<div class="col-md-offset-9">
																	...
																	<a href="<?php echo base_url(); ?>anggaran-kas/murni/sub/<?php echo $rincian; ?>" class="btn btn-default">Batal</a>
																</div>
															</div>
														</div>
													</div>
