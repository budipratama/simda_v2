                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="body">
										<div class="row clearfix">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<form action="<?php echo site_url('anggaran-kas/murni/edit/'.$kode);?>" id="form_validation" enctype="multipart/form-data" method="post"><br>
											...
											<div class="form-group">
												<div class="col-md-offset-9">
													...
													<a href="<?php echo base_url(); ?>anggaran-kas/murni/belanja/<?php echo $id_anggaran;?>" class="btn btn-default">Batal</a>
												</div>
											</div>
											</form>
											</div>
...
<!-- END CONTENT -->
	...
	function show_form_akun_by_kelompok(){
		...
		load('anggaran-kas/murni/tampil_combobox_akun_by_kelompok/'+aaa_kode, '#tampil_combobox_akun_by_kelompok');
		load('anggaran-kas/murni/tampil_combobox_kelompok_by_jenis/', '#tampil_combobox_kelompok_by_jenis');
		load('anggaran-kas/murni/tampil_combobox_jenis_by_obyek/', '#tampil_combobox_jenis_by_obyek');
		load('anggaran-kas/murni/tampil_combobox_obyek_by_rincian/', '#tampil_combobox_obyek_by_rincian');
	}
	
	function show_form_kelompok_by_jenis(){
		var bbb_kode = $('select[name=bbb_kode]').val();
		load('anggaran-kas/murni/tampil_combobox_kelompok_by_jenis/'+bbb_kode, '#tampil_combobox_kelompok_by_jenis');
		load('anggaran-kas/murni/tampil_combobox_jenis_by_obyek/', '#tampil_combobox_jenis_by_obyek');
		load('anggaran-kas/murni/tampil_combobox_obyek_by_rincian/', '#tampil_combobox_obyek_by_rincian');
	}
	...
	function show_form_jenis_by_obyek(){
		...
		load('anggaran-kas/murni/tampil_combobox_jenis_by_obyek/'+ccc_kode, '#tampil_combobox_jenis_by_obyek');
		load('anggaran-kas/murni/tampil_combobox_obyek_by_rincian/', '#tampil_combobox_obyek_by_rincian');
	}
	
	function show_form_obyek_by_rincian(){
		var ddd_kode = $('select[name=ddd_kode]').val();
		load('anggaran-kas/murni/tampil_combobox_obyek_by_rincian/'+ddd_kode, '#tampil_combobox_obyek_by_rincian');
	}
	</script>