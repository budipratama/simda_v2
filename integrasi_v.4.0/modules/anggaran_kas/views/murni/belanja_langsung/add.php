...
<script language="javascript">
	function hasil(){
		var bil1=parseFloat(document.getElementById("angka1").value);
		if (isNaN (bil1))
		bil1=0.0;
			var bil2=parseFloat(document.getElementById("angka2").value);
			if(isNaN(bil2))
			bil2=0.0;
				var result=bil1/bil2; 
				document.getElementById("jan").value = result;
				document.getElementById("feb").value = result;
				document.getElementById("mar").value = result;
				document.getElementById("apr").value = result;
				document.getElementById("mei").value = result;
				document.getElementById("jun").value = result;
				document.getElementById("jul").value = result;
				document.getElementById("ags").value = result;
				document.getElementById("sep").value = result;
				document.getElementById("okt").value = result;
				document.getElementById("nov").value = result;
