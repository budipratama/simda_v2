						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<div class="body">
									<div class="row clearfix">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<form action="aa" name="formku" method="POST" >
										<div class="row clearfix">
										<div class="col-md-6">
										...
										<div class="col-md-offset-11">
											<button class="btn btn-primary waves-effect" type="submit" >Bagi Rata</button>																	
										</div>
										</div>														
															...
															<div class="row clearfix">
																...
																<div class="form-group form-float">
																	<div class="form-line">
																		<input type="text" class="form-control" name="" id="" value="<?php echo $a;?>" maxlength="16" style="text-align:right;">
...
<input type="text" id="jumlah">
  ...
  <input type="text" id="input_form1" value="90"/>
  <input type="text" id="input_form2" value="90"/>
  <button onsubmit="return false" id="tombol_form">Tampilkan Nilai</button>
...
function tampilkan_nilai_form(){
    var nilai_form1=document.getElementById("input_form1").value;
    var nilai_form2=document.getElementById("input_form2").value;
	if  { hasil = parseInt(nilai_form1)+parseInt(nilai_form2);
