...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="data_table">	
	...
	<tr>
		...
		<td style="text-align:left; font-size: 9px;" colspan="4" ><?php echo $rka->jenis_urusan; ?> <?php echo $rka->nama_urusan; ?></td>
    </tr>
	<tr>
	...
	<tr>
		...
		<td style="text-align:left;" colspan="2" >: 1.<?php echo $rka->id_urusan; ?> . 1.<?php echo $rka->id_urusan; ?>.<?php echo $rka->no_skpd; ?> . <?php echo $rka->no_program; ?></td>
	...
	<tr>
		...
		<td style="text-align:left;" colspan="2" >: 1.<?php echo $rka->id_urusan; ?> . 1.<?php echo $rka->id_urusan; ?>.<?php echo $rka->no_skpd; ?> . <?php echo $rka->no_program; ?> . <?php echo $rka->no_anggaran; ?></td>
