...
class PDF extends FPDF {
	...
	function Header() {
                ...
                $this->Image(base_url().'public/dist/img/logo.jpg', 10, 25,'20','20','jpeg');
                
                $this->Ln(12);
                $this->setFont('Arial','',14);
                $this->setFillColor(255,255,255);
                $this->cell(25,6,'',0,0,'C',0); 
                $this->cell(100,6,"RENCANA KERJA DAN ANGGARAN",0,1,'L',1);				 
                $this->cell(25,6,'',0,0,'C',0); 
                $this->cell(100,6,"SATUAN KERJA PERANGKAT DAERAH",0,1,'L',1);   
                $this->cell(25,6,'',0,0,'C',0); 
