            ...
            <div class="panel panel-primary">
				...
				<div class="portlet-body form">
					<div class="form-body">
						<div class="row">
							<div class="col-md-12">
								<div style="display:block;"><iframe frameborder="0" width="100%" height="500" name="form_laporan" src="<?php echo site_url('rka/murni/hasil');?>"></iframe></div>
							</div>
						</div>
					</div>						
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
										...
										<a href="<?php echo site_url('rka/murni/hasil/excel');?>" class="btn green"><i class="fa fa-file-excel-o"></i> Download Excel</a>
