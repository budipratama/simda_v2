		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<p class="control-label col-md-9"><i class="fa fa-bars"></i> Data Kode Rekening</p><p align="right">
					...
					<a class="btn btn-success" title="Tambah" href="<?php echo site_url('rka/murni/belanja-langsung/'.$kode);?>"><i class="fa fa-plus"> Belanja</i></a>
				</div>
				<div class="panel-body">
				<!-- BEGIN FORM -->
				<div class="step">
						...
						<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td><a href="<?php echo base_url(); ?>rka/murni/rincian/<?php echo $task->task_id; ?>"><?php echo $task->nama_rincian; ?></a></td>
									<td style="text-align:center;"><?php echo $task->id_tipe; ?></td>
									<td style="text-align:center;">										
										<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo base_url(); ?>rka/murni/edit/<?php echo $task->task_id; ?>" value="<?php echo $task->kode; ?>"><i class="fa fa-pencil"></i></a>
										<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" value="<?php echo $task->kode; ?>" href="<?php echo base_url(); ?>rka/murni/deleteb/<?php echo $task->task_id; ?>/<?php echo $this->uri->segment(1); ?>" ><i class="fa fa-trash-o"></i></a>
									</td>
								</tr>
