                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a title="Tambah" href="<?php echo site_url('rka/perubahan/addr/'.$rka->task_id);?>"><i class="material-icons">add_circle_outline</i> Rincian Belanja</a></li>
                                        <li><a title="Kembali" href="<?php echo base_url(); ?>rka/perubahan/belanja/<?php echo $rka->anggaran_kode;?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="row clearfix">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        <li><p class="col-cyan"><a href="<?php echo base_url(); ?>rka/perubahan/belanja/<?php echo $rka->anggaran_kode;?>"><i class="material-icons">keyboard_arrow_left</i>Belanja</a></p></li>									
											...
											<tbody><?php if($rincian) : ?><?php foreach($rincian as $task) : ?>
												<tr>
													...
													<td style="text-align:center;">										
														...
														<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" value="<?php echo $task->kode; ?>" href="<?php echo base_url(); ?>rka/perubahan/deleter/<?php echo $task->kode; ?>/<?php echo $this->uri->segment(1); ?>" ><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
