<!-- Main Content -->   
   <section class="content">
		<h2>RKPD Murni<small> entri data &amp; informasi detail</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					<li><a href="<?php echo site_url('dashboard');?>"><i class="material-icons">home</i> Home</a></li>
					<li><a href="<?php echo site_url('rkpd/murni');?>"> RKPD Murni</a></li>
                            ...
                            <div class="row clearfix">
								...
								<div id="collapseOne_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_19">
									<div class="body" style="<?php echo (isset($formCari)?'display:none;':'')?>">
										<form action="<?php echo site_url('rkpd/murni/cari');?>" class="form-horizontal" method="post">
											<div class="row clearfix">
												<div class="col-md-2">
													<p><b>Tahun :</b></p>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data <font color="green"><strong>"RKPD Murni"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"KUA & PPAS Murni"</strong></font>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data <font color="green"><strong>"RKPD Murni"</strong></font> sudah ditransfer ke <font color="blue"><strong>"KUA & PPAS Murni"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
