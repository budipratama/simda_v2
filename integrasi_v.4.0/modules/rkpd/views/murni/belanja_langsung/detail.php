<!-- Main Content -->   
   <section class="content">
		<h2>RKPD Murni <small> anggaran belanja langsung</small></h2>
			<div class="body">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
							<div class="body">
							<form action="<?php echo site_url('rkpd/insert/bl');?>" id="form_validation" enctype="multipart/form-data" method="POST">
								<div class="row clearfix">
									<div class="col-md-3">
										<p><b>Tahun :</b></p>
