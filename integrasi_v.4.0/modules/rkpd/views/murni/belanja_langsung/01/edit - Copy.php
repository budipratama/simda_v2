<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Ubah RKPD Murni <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('rkpd/murni');?>">RKPD Murni</a>
						<i class="fa fa-angle-right"></i>
					</li>
                     <li>
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form ubah RKPD Murni ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-pencil"></i>Ubah RKPD Murni
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('rkpd/murni/update/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
	...
	function show_form_misi_by_skpd(){
		...
		load('rkpd/murni/tampil_combobox_misi_by_skpd/'+skpd_kode, '#tampil_combobox_misi_by_skpd');
		load('rkpd/murni/tampil_combobox_tujuan_by_misi/', '#tampil_combobox_tujuan_by_misi');
		load('rkpd/murni/tampil_combobox_sasaran_by_tujuan/', '#tampil_combobox_sasaran_by_tujuan');
		load('rkpd/murni/tampil_combobox_indikator_by_sasaran/', '#tampil_combobox_indikator_by_sasaran');
		load('rkpd/murni/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('rkpd/murni/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	
	function show_form_tujuan_by_misi(){
		var skpd_kode = $('select[name=skpd_kode]').val();
		var misi_kode = $('select[name=misi_kode]').val();
		load('rkpd/murni/tampil_combobox_tujuan_by_misi/'+skpd_kode+'/'+misi_kode, '#tampil_combobox_tujuan_by_misi');
		load('rkpd/murni/tampil_combobox_sasaran_by_tujuan/', '#tampil_combobox_sasaran_by_tujuan');
		load('rkpd/murni/tampil_combobox_indikator_by_sasaran/', '#tampil_combobox_indikator_by_sasaran');
		load('rkpd/murni/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('rkpd/murni/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	...
	function show_form_sasaran_by_tujuan(){
		...
		load('rkpd/murni/tampil_combobox_sasaran_by_tujuan/'+skpd_kode+'/'+tujuan_kode, '#tampil_combobox_sasaran_by_tujuan');
		load('rkpd/murni/tampil_combobox_indikator_by_sasaran/', '#tampil_combobox_indikator_by_sasaran');
		load('rkpd/murni/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('rkpd/murni/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_indikator_by_sasaran(){
		...
		load('rkpd/murni/tampil_combobox_indikator_by_sasaran/'+skpd_kode+'/'+tujuan_kode+'/'+sasaran_kode, '#tampil_combobox_indikator_by_sasaran');
		load('rkpd/murni/tampil_combobox_urusan_by_indikator/', '#tampil_combobox_urusan_by_indikator');
		load('rkpd/murni/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_urusan_by_indikator(){
		...
		load('rkpd/murni/tampil_combobox_urusan_by_indikator/'+skpd_kode+'/'+tujuan_kode+'/'+indikator_kode, '#tampil_combobox_urusan_by_indikator');
		load('rkpd/murni/tampil_combobox_program_by_urusan/', '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_program_by_urusan(){
		...
		load('rkpd/murni/tampil_combobox_program_by_urusan/'+skpd_kode+'/'+urusan_kode, '#tampil_combobox_program_by_urusan');
	}
	...
	function show_form_kegiatan_by_program(){
		...
		var skpd_kode = $('select[name=skpd_kode]').val();
		load('rkpd/murni/tampil_combobox_kegiatan_by_program/'+urusan_kode+'/'+program_kode+'/'+skpd_kode, '#tampil_combobox_kegiatan_by_program');
		load('rkpd/murni/tampil_combobox_hasil_by_program/'+program_kode, '#tampil_combobox_hasil_by_program');
		load('rkpd/murni/tampil_kegiatan_lainnya/', '#tampil_combobox_kegiatan_lainnya');
	}

	function show_form_kegiatan_lainnya(){
		var kegiatan = $('select[name=kegiatan]').val();
		load('rkpd/murni/tampil_kegiatan_lainnya/'+kegiatan, '#tampil_combobox_kegiatan_lainnya');
	}
	
	function show_form_deskel_by_kecamatan(){
		var kecamatan_kode = $('select[name=kecamatan_kode]').val();
		load('rkpd/murni/tampil_combobox_deskel_by_kecamatan2/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
