<!-- Main Content -->   
   <section class="content">
		<h2>RKPD Perubahan<small> entri data &amp; informasi detail</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					<li><a href="<?php echo site_url('dashboard');?>"><i class="material-icons">home</i> Home</a></li>
					<li><a href="<?php echo site_url('rkpd/perubahan');?>"> RKPD</a></li>
                        ...
                        <div class="body">
                            <div class="row clearfix">
								<div class="panel-heading" role="tab" id="headingOne_19" data-toggle="tooltip" data-placement="top" title="Form Pencairan">
									...
									<a href="<?php echo site_url('rkpd/perubahan');?>">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Success!</strong> Transfer RKPD Perubahan</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"RKPD Perubahan"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"KUA & PPAS Perubahan"</strong></font>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Transfer RKPD Perubahan</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"RKPD Perubahan"</strong></font> sudah ditransfer ke <font color="blue"><strong>"KUA & PPAS Perubahan"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successDelete" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Hapus RKPD Perubahan</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"RKPD Perubahan"</strong></font> telah berhasil dihapus !</font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
