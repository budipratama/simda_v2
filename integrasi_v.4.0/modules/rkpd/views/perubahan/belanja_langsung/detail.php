<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Detail RKPD Perubahan <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Data Detail RKPD Perubahan
							</div>
						</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													...
													<!--<a href="<?php echo site_url('rkpd/perubahan/edit/'.$kode);?>" class="btn green"><i class="fa fa-pencil"></i> Ubah</a>-->
													<a href="<?php echo site_url('rkpd/perubahan/transfer/'.$kode);?>" class="btn blue"><i class="fa fa-paper-plane"></i> Transfer ke KUA & PPAS Perubahan</a>
												</div>
											</div>
										</div>
										<div class="col-md-6">
