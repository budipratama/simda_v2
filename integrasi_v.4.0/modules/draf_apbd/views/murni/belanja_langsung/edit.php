...
<div class="container-fluid">
	<div class="side-body padding-top">
		<h3 class="page-title">Ubah Pra APBD Kabupaten Murni <small>anggaran belanja langsung</small></h3>
		<div class="row">
			<div class="col-xs-12">
				<div class="bs-example">
					<ol class="breadcrumb">
						<li class="active"><i class="fa fa-home"></i> <a href="<?php echo site_url('dashboard');?>">Home</a></li>
						<li class="active"><a href="<?php echo site_url('draf-apbd/murni');?>">KUA &amp; PPAS Murni</a></li>
			...
			<!-- BEGIN FORM -->
				<div class="panel panel-success">
					...
					<div class="panel-body">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('draf-apbd/murni/update/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
...
<!-- END CONTENT -->
	...
	function show_form_kegiatan_by_program(){
		...
		load('draf-apbd/murni/tampil_kegiatan_lainnya/', '#tampil_combobox_kegiatan_lainnya');
	}
