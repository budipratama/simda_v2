<!-- Main Content -->
            <div class="container-fluid">
				...
				<h3 class="page-title">Detail Pra APBD Kabupaten Murni <small>anggaran belanja langsung</small></h3>
                        ...
                        <div class="col-xs-12">
							<div class="bs-example">
								<ol class="breadcrumb">
									...
									<li class="active"><a href="<?php echo site_url('draf-apbd/murni');?>"> RKPD Murni</a></li>
									...
									<div class="col-md-12">
										<div class="col-md-offset-1 col-md-12">
											<a href="#" onClick="history.go(-1); return false;" class="btn btn-default"><i class="fa fa-reply"></i> Kembali</a>
													<a href="<?php echo site_url('draf-apbd/murni/edit/'.$kode);?>" class="btn btn-success"><i class="fa fa-pencil"></i> Ubah</a>
								
										<div class="btn-group" style="margin-left:100px;">
											<a href="<?php echo site_url('draf-apbd/murni/delete/'.$kode);?>" class="btn red" onclick="return confirm('Apakah anda yakin? \nAkan menghapus data KUA & PPAS ini.');"><i class="fa fa-trash-o"></i> Hapus</a>
										</div>
										</div>
