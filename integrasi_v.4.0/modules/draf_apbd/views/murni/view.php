	...
	<div class="side-body padding-top">
		...
		<div class="row">
            <div class="col-xs-12">
				<div class="bs-example">
					<ol class="breadcrumb">
						...
						<li class="active"><a href="<?php echo site_url('draf-apbd/murni');?>">Pra APBD Kabupaten</a></li>
			...
			<div class="panel panel-success">
				...
				<form action="<?php echo site_url('draf-apbd/murni/cari');?>" class="form-horizontal" method="post">
					...
					<div style="margin-left:500px;">
						<div class="col-md-12">
							<div class="col-md-offset-1 col-md-12">
								...
								<a href="<?php echo site_url('draf-apbd/murni');?>" id="confirmasiHapus" class="btn btn-default"><i class="fa fa-eraser"></i> Clear</a>							</div>
						</div>
					</div>
					<!--/row-->							
					</form>
