<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Detail KUA &amp; PPAS Perubahan <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Data Detail KUA &amp; PPAS Perubahan
							</div>
						</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													...
													<a href="<?php echo site_url('kua-ppas/perubahan/edit/'.$kode);?>" class="btn green"><i class="fa fa-pencil"></i> Ubah</a>
													<a href="<?php echo site_url('kua-ppas/perubahan/delete/'.$kode);?>" class="btn red" onclick="return confirm('Apakah anda yakin? \nAkan menghapus data rencana kerja ini.');"><i class="fa fa-trash-o"></i> Hapus</a>
												</div>
											</div>
										</div>
									</div>
