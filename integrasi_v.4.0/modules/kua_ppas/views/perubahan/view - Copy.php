<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Hasil KUA & PPAS Perubahan <small>entri data &amp; informasi detail</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
                    ...
                    <li>
						<a href="<?php echo site_url('kua-ppas/perubahan');?>">KUA & PPAS</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<?php echo site_url('kua-ppas/perubahan');?>">Perubahan</a>
					</li>
				</ul>
			</div>
            <!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-search"></i>Pencarian Hasil KUA & PPAS Perubahan
										</div>
										<div class="tools">
									...
									<div class="portlet-body form" style="<?php echo (isset($formCari)?'display:none;':'')?>">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('kua-ppas/perubahan/cari');?>" class="form-horizontal" method="post">
											<div class="form-body">
													...
													<div class="col-md-12">
														<div class="row">
															<div class="col-md-offset-1 col-md-12">
																<button type="submit" class="btn green"><i class="fa fa-check"></i>  Cari Hasil KUA & PPAS Perubahan</button>
																<a href="<?php echo site_url('kua-ppas/perubahan');?>" class="btn default"> <i class="fa fa-times"></i> Bersihkan Hasil Pencarian</a>
																<!--
																<div class="btn-group" style="margin-left:100px;">
																	<button type="button" class="btn blue dropdown-toggle" data-toggle="dropdown"><i class="fa fa-plus"></i> Tambah Hasil KUA & PPAS Perubahan</button>
																	<button type="button" class="btn blue dropdown-toggle" data-toggle="dropdown"><i class="fa fa-angle-down"></i></button>
																	<ul class="dropdown-menu" role="menu">
																	<li>
																		<a href="<?php echo site_url('kua-ppas/perubahan/belanja-langsung');?>">Belanja Langsung</a>
																	</li>
																	<li>
																		<a href="<?php echo site_url('kua-ppas/perubahan/belanja-tidak-langsung');?>">Belanja Tidak Langsung</a>
																	</li>
																	</ul>
																</div>
																-->
            ...
            <div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>Daftar Hasil KUA & PPAS Perubahan
							</div>
						</div>
						<script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Success!</strong> Tambah KUA & PPAS Perubahan</h4>
				</div>
				<div class="modal-body">
					 Data KUA & PPAS perubahan telah berhasil ditambahkan !
				</div>
	...
	<div id="successUpdate" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data KUA & PPAS perubahan telah berhasil diperbaharui !
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successDelete" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data KUA & PPAS perubahan telah berhasil dihapus !
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					 Data KUA & PPAS perubahan telah berhasil ditransfer ke musrenbang kabupaten!
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('kua-ppas/perubahan/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>