<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Transfer KUA & PPAS Murni <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form transfer KUA & PPAS Murni ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-paper-plane"></i>Transfer KUA & PPAS Murni
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?php echo site_url('kua-ppas/murni/doTransfer/bl/'.$kode);?>" class="horizontal-form" enctype="multipart/form-data" method="post">
											<div class="form-body">
	...
	function show_form_kegiatan_by_program(){
		...
		load('kua-ppas/murni/tampil_combobox_hasil_by_program/'+program_kode+'/'+skpd_kode, '#tampil_combobox_hasil_by_program');
