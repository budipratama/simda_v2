<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Ubah KUA &amp; PPAS Murni <small>anggaran belanja langsung</small>
			</h3>
			<div class="page-bar">
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form ubah KUA &amp; PPAS Murni ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-pencil"></i>Ubah KUA &amp; PPAS Murni
										</div>
									</div>
