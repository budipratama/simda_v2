<!-- Main Content -->
            <div class="container-fluid">
				...
				<h3 class="page-title">Detail KUA &amp; PPAS Murni <small>anggaran belanja langsung</small></h3>
							...
							<form class="form-horizontal" role="form">							
								...
								<div style="margin-left:83px;">
									<div class="col-md-12">
										...
										<a href="<?php echo site_url('kua-ppas/murni/transfer/'.$kode);?>" class="btn btn-info"><i class="fa fa-paper-plane"></i> Transfer ke RKA</a>
										</div>
